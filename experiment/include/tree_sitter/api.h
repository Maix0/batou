...
#define TREE_SITTER_MIN_COMPATIBLE_LANGUAGE_VERSION 13
	 ...
	 */
	TSTree *ts_parser_parse(TSParser *self, const TSTree *old_tree,
							TSInput input);
	 ...
	 */
	bool ts_query_is_pattern_rooted(const TSQuery *self,
									uint32_t	   pattern_index);
	 ...
	 */
	bool ts_query_is_pattern_non_local(const TSQuery *self,
									   uint32_t		  pattern_index);
	 ...
	 */
	void ts_query_disable_capture(TSQuery *self, const char *name,
								  uint32_t length);
	 ...
	 */
	TSSymbol ts_lookahead_iterator_current_symbol(
		const TSLookaheadIterator *self);
