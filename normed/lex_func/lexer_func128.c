...
enum e_lex_ret	lex_func_639(t_lexer	*lexer, t_lex_state	*s)
{
	s->result = true;
...
enum e_lex_ret	lex_func_640(t_lexer	*lexer, t_lex_state	*s)
{
	s->result = true;
	lexer->result_symbol = anon_sym_STAR;
	lexer->mark_end(lexer);
...
enum e_lex_ret	lex_func_641(t_lexer	*lexer, t_lex_state	*s)
{
	s->result = true;
...
enum e_lex_ret	lex_func_642(t_lexer	*lexer, t_lex_state	*s)
{
	s->result = true;
	lexer->result_symbol = anon_sym_SLASH;
	lexer->mark_end(lexer);
...
enum e_lex_ret	lex_func_643(t_lexer	*lexer, t_lex_state	*s)
{
	s->result = true;
	lexer->result_symbol = anon_sym_SLASH;
	lexer->mark_end(lexer);
