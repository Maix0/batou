...
enum e_lex_ret	lex_func_474(t_lexer	*lexer, t_lex_state	*s)
{
	if (lex_advence_map_474(lexer, s))
		return (s->lex_ret);
	if (s->lookahead == '\\')
...
enum e_lex_ret	lex_func_475(t_lexer	*lexer, t_lex_state	*s)
{
	if (lex_advence_map_475(lexer, s))
		return (s->lex_ret);
	if (('\t' <= s->lookahead && s->lookahead <= '\r') || \
	s->lookahead == ' ')
...
enum e_lex_ret	lex_func_476(t_lexer	*lexer, t_lex_state	*s)
{
	if (lex_advence_map_476(lexer, s))
		return (s->lex_ret);
	if (s->lookahead == '\\')
...
enum e_lex_ret	lex_func_477(t_lexer	*lexer, t_lex_state	*s)
{
	if (s->lookahead == '"')
...
enum e_lex_ret	lex_func_478(t_lexer	*lexer, t_lex_state	*s)
{
	if (lex_advence_map_478(lexer, s))
		return (s->lex_ret);
	if (('\t' <= s->lookahead && s->lookahead <= '\r') || \
	s->lookahead == ' ')
