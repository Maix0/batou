...
{
	v->arr[1] = (t_fme){field_redirect, 0};
	v->arr[2] = (t_fme){field_descriptor, 0};
	...
	v->arr[10] = (t_fme){field_destination, 1};
	v->arr[11] = (t_fme){field_operator, 0};
	v->arr[12] = (t_fme){field_body, 0};
	v->arr[13] = (t_fme){field_redirect, 1};
	v->arr[14] = (t_fme){field_body, 0};
	v->arr[15] = (t_fme){field_argument, 0};
...
void	init_fmap_entries1(t_fmap_entries *v)
{
	...
	v->arr[17] = (t_fme){field_name, 0};
	v->arr[18] = (t_fme){field_redirect, 1, .inherited = true};
	v->arr[19] = (t_fme){field_name, 1};
	...
	v->arr[23] = (t_fme){field_descriptor, 0};
	v->arr[24] = (t_fme){field_destination, 2};
	v->arr[25] = (t_fme){field_name, 0};
	v->arr[26] = (t_fme){field_value, 2};
	v->arr[27] = (t_fme){field_name, 0, .inherited = true};
	v->arr[28] = (t_fme){field_value, 0, .inherited = true};
	v->arr[29] = (t_fme){field_operator, 1};
	v->arr[30] = (t_fme){field_body, 2};
	init_fmap_entries2(v);
}

void	init_fmap_entries2(t_fmap_entries *v)
{
	v->arr[31] = (t_fme){field_condition, 1};
	v->arr[32] = (t_fme){field_body, 2};
	v->arr[33] = (t_fme){field_name, 1};
	...
	v->arr[40] = (t_fme){field_redirect, 1};
	v->arr[41] = (t_fme){field_argument, 0};
	v->arr[42] = (t_fme){field_argument, 1};
...
void	init_fmap_entries3(t_fmap_entries *v)
{
	...
	v->arr[48] = (t_fme){field_name, 1};
	v->arr[49] = (t_fme){field_redirect, 0, .inherited = true};
	v->arr[50] = (t_fme){field_redirect, 2, .inherited = true};
	v->arr[51] = (t_fme){field_index, 2};
	v->arr[52] = (t_fme){field_name, 0};
	v->arr[53] = (t_fme){field_body, 3};
	v->arr[54] = (t_fme){field_variable, 1};
	v->arr[55] = (t_fme){field_left, 0};
	v->arr[56] = (t_fme){field_operator, 1};
	v->arr[57] = (t_fme){field_right, 2};
	v->arr[58] = (t_fme){field_condition, 1};
	v->arr[59] = (t_fme){field_value, 1};
	v->arr[60] = (t_fme){field_body, 2};
	init_fmap_entries4(v);
}

void	init_fmap_entries4(t_fmap_entries *v)
{
	v->arr[61] = (t_fme){field_name, 1};
	v->arr[62] = (t_fme){field_redirect, 3};
	v->arr[63] = (t_fme){field_operator, 0};
	v->arr[64] = (t_fme){field_operator, 1};
	v->arr[65] = (t_fme){field_operator, 0};
	v->arr[66] = (t_fme){field_operator, 1, .inherited = true};
	v->arr[67] = (t_fme){field_operator, 0};
	v->arr[68] = (t_fme){field_operator, 2};
	v->arr[69] = (t_fme){field_operator, 0};
	v->arr[70] = (t_fme){field_operator, 2, .inherited = true};
	v->arr[71] = (t_fme){field_body, 3};
	v->arr[72] = (t_fme){field_name, 0};
	v->arr[73] = (t_fme){field_body, 4};
