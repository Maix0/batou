...
void	init_pae145(t_parse_action_entries *v)
{
	...
	v->arr[1972] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1161)}}};
	v->arr[1973] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[1974] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1161)}}};
...
TSParseActionTypeReduce, symbol = aux_sym_command_repeat2, .child_count = 2, \
	...
	v->arr[1976] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1093), repetition = true}}};
	v->arr[1978] = (t_pae){.entry = {.count = 2, .reusable = false}};
	v->arr[1979] = (t_pae){.action = {reduce = {.type = \
TSParseActionTypeReduce, symbol = aux_sym_command_repeat2, .child_count = 2, \
	dynamic_precedence = 0, .production_id = 38}}};
	v->arr[1979] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
