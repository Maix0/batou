...
void	init_pae941(t_parse_action_entries *v)
{
	...
	TSParseActionTypeShift, .state = (5529), repetition = true}}};
	v->arr[12854] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[12855] = (t_pae){.action = {.shift = {.type = \
	TSParseActionTypeShift, .state = (7022)}}};
...
TSParseActionTypeReduce, symbol = sym__expansion_max_length, .child_count = 3, \
	...
	TSParseActionTypeShift, .state = (6105)}}};
...
TSParseActionTypeReduce, symbol = sym__expansion_max_length, .child_count = 4, \
	...
	TSParseActionTypeShift, .state = (6275)}}};
	init_pae943(v);
}
...
void	init_pae944(t_parse_action_entries *v)
{
	...
	TSParseActionTypeShift, .state = (1178), repetition = true}}};
