...
{
	v->arr[4845] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (962)}}};
	v->arr[4846] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4847] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2538)}}};
	v->arr[4848] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4849] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (7624)}}};
	v->arr[4850] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4851] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (920)}}};
...
ACT_TY_REDUCE, .symbol = aux_sym__literal_repeat1, .child_count = 2, \
	...
	v->arr[4853] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1052), .repetition = true}}};
	v->arr[4855] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[4856] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2655)}}};
	v->arr[4857] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[4858] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5832)}}};
	init_pae366(v);
}
...
void	init_pae366(t_parse_action_entries *v)
{
	...
	v->arr[4860] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2653)}}};
	v->arr[4861] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4862] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2653)}}};
	v->arr[4863] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4864] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1912)}}};
	v->arr[4865] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[4866] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2516)}}};
	v->arr[4867] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[4868] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5725)}}};
	v->arr[4869] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[4870] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2515)}}};
	v->arr[4871] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4872] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2515)}}};
...
{
	v->arr[4874] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1105)}}};
	v->arr[4875] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4876] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4179)}}};
	v->arr[4877] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[4878] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (979)}}};
