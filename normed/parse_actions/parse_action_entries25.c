...
{
	v->arr[1749] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (7652), .repetition = true}}};
	v->arr[1751] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1752] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1067)}}};
	v->arr[1753] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1754] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3755)}}};
	v->arr[1755] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1756] = (t_pae){.action = {.reduce = {.type = \
ACT_TY_REDUCE, .symbol = sym_declaration_command, .child_count = 1, \
...
ACT_TY_REDUCE, .symbol = sym_declaration_command, .child_count = 1, \
	...
	v->arr[1760] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3754)}}};
	v->arr[1761] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1762] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5924)}}};
	init_pae129(v);
}
...
void	init_pae129(t_parse_action_entries *v)
{
	...
	v->arr[1764] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1092)}}};
	v->arr[1765] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1766] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5823)}}};
	v->arr[1767] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1768] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1235)}}};
	v->arr[1769] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1770] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (6282)}}};
	v->arr[1771] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1772] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4703)}}};
	v->arr[1773] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1774] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (348)}}};
	v->arr[1775] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1776] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (347)}}};
