...
{
	v->arr[3988] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
...
{
	v->arr[4036] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (7625), .repetition = true}}};
	v->arr[4038] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4039] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (6452)}}};
	v->arr[4040] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4041] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (6395)}}};
	v->arr[4042] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[4043] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3368)}}};
	v->arr[4044] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[4045] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (726)}}};
	v->arr[4046] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[4047] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2843)}}};
	v->arr[4048] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[4049] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2848)}}};
	v->arr[4050] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[4051] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4582)}}};
	init_pae305(v);
}
