...
void	init_pae926(t_parse_action_entries *v)
{
	...
	TSParseActionTypeShift, .state = (5410)}}};
...
void	init_pae927(t_parse_action_entries *v)
{
	...
	TSParseActionTypeShift, .state = (6208)}}};
...
TSParseActionTypeReduce, symbol = aux_sym__literal_repeat1, .child_count = 2, \
	...
	TSParseActionTypeShift, .state = (5416), repetition = true}}};
...
void	init_pae929(t_parse_action_entries *v)
{
	...
	TSParseActionTypeShift, .state = (3890), repetition = true}}};
...
TSParseActionTypeReduce, .symbol = sym_case_item, child_count = 4, \
	...
	TSParseActionTypeShift, .state = (4199)}}};
