...
{
	v->arr[5450] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3698)}}};
	v->arr[5451] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5452] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5427)}}};
	v->arr[5453] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5454] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5427)}}};
	v->arr[5455] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5456] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5476)}}};
...
ACT_TY_REDUCE, .symbol = aux_sym__literal_repeat1, .child_count = 2, \
	...
	v->arr[5458] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
...
ACT_TY_REDUCE, .symbol = aux_sym_command_repeat2, .child_count = 1, \
	...
	v->arr[5465] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3942)}}};
	v->arr[5466] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5467] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3942)}}};
...
ACT_TY_REDUCE, .symbol = aux_sym_unset_command_repeat1, .child_count = \
	...
	v->arr[5473] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3895)}}};
	v->arr[5474] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5475] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3895)}}};
	init_pae412(v);
}
...
ACT_TY_REDUCE, .symbol = aux_sym__literal_repeat1, .child_count = 2, \
	.dynamic_precedence = 0, .production_id = 0}}};
	v->arr[5481] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1404), .repetition = true}}};
	v->arr[5483] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5484] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3810)}}};
	v->arr[5485] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5486] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1404)}}};
	v->arr[5487] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5488] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3814)}}};
	init_pae413(v);
}
...
void	init_pae413(t_parse_action_entries *v)
{
	...
	v->arr[5490] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4002)}}};
