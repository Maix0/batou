...
{
	v->arr[3246] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
...
{
	v->arr[3270] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (7634), .repetition = true}}};
	v->arr[3272] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3273] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1773)}}};
	v->arr[3274] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3275] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5784)}}};
	v->arr[3276] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3277] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1775)}}};
	v->arr[3278] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[3279] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1775)}}};
	v->arr[3280] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3281] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1700)}}};
	v->arr[3282] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3283] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5764)}}};
	v->arr[3284] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3285] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1586)}}};
	init_pae248(v);
}
