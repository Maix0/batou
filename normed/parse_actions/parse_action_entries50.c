...
{
	v->arr[3331] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (7629), .repetition = true}}};
	v->arr[3333] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3334] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1526)}}};
	v->arr[3335] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3336] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3817)}}};
	v->arr[3337] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3338] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3820)}}};
	v->arr[3339] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3340] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (6061)}}};
	v->arr[3341] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3342] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1725)}}};
	v->arr[3343] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3344] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1782)}}};
	v->arr[3345] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3346] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (6252)}}};
	init_pae253(v);
}
...
void	init_pae253(t_parse_action_entries *v)
{
	...
	v->arr[3348] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4672)}}};
	v->arr[3349] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3350] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (302)}}};
	v->arr[3351] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3352] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (301)}}};
	v->arr[3353] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3354] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (300)}}};
	v->arr[3355] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3356] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (368)}}};
	v->arr[3357] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[3358] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1524)}}};
	v->arr[3359] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[3360] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (7665)}}};
...
{
	v->arr[3362] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4271)}}};
	v->arr[3363] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3364] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3728)}}};
	v->arr[3365] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3366] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3726)}}};
	v->arr[3367] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3368] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5994)}}};
	v->arr[3369] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3370] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4259)}}};
	v->arr[3371] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3372] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5811)}}};
	v->arr[3373] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3374] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4600)}}};
	v->arr[3375] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3376] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (6284)}}};
	init_pae255(v);
}
