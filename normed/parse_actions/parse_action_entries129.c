...
{
	v->arr[8690] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (7632), .repetition = true}}};
	v->arr[8692] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[8693] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5477)}}};
	v->arr[8694] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[8695] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5761)}}};
	v->arr[8696] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[8697] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5483)}}};
	v->arr[8698] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8699] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5483)}}};
	v->arr[8700] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[8701] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (6420)}}};
	v->arr[8702] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8703] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (6420)}}};
	v->arr[8704] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8705] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (6393)}}};
	init_pae647(v);
}
...
void	init_pae647(t_parse_action_entries *v)
{
	...
	v->arr[8707] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2020)}}};
	v->arr[8708] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8709] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2817)}}};
	v->arr[8710] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8711] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1561)}}};
	v->arr[8712] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[8713] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5485)}}};
	v->arr[8714] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[8715] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5830)}}};
	v->arr[8716] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[8717] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5486)}}};
	v->arr[8718] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8719] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5486)}}};
...
{
	v->arr[8721] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (6371)}}};
	v->arr[8722] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8723] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (6421)}}};
	v->arr[8724] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8725] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1731)}}};
	v->arr[8726] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8727] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4688)}}};
	v->arr[8728] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8729] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5552)}}};
	v->arr[8730] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8731] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1556)}}};
	v->arr[8732] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8733] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1729)}}};
	v->arr[8734] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8735] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (6392)}}};
	init_pae649(v);
}
...
void	init_pae649(t_parse_action_entries *v)
{
	...
	v->arr[8737] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2247)}}};
	v->arr[8738] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8739] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4636)}}};
	v->arr[8740] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8741] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5610)}}};
	v->arr[8742] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8743] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2253)}}};
	v->arr[8744] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8745] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (6378)}}};
	v->arr[8746] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8747] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2807)}}};
	v->arr[8748] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8749] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (6505)}}};
