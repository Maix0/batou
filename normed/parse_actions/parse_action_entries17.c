...
{
	v->arr[1202] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (460)}}};
	v->arr[1203] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[1204] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (4291)}}};
	v->arr[1205] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[1206] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3657)}}};
	v->arr[1207] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[1208] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2983)}}};
	v->arr[1209] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[1210] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3671)}}};
	v->arr[1211] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1212] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2588)}}};
	v->arr[1213] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1214] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2069)}}};
	v->arr[1215] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[1216] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2184)}}};
	init_pae86(v);
}
...
void	init_pae86(t_parse_action_entries *v)
{
	...
	v->arr[1218] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2188)}}};
	v->arr[1219] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[1220] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2188)}}};
	v->arr[1221] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[1222] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2537)}}};
	v->arr[1223] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[1224] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2588)}}};
	v->arr[1225] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[1226] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (463)}}};
	v->arr[1227] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1228] = (t_pae){.action = {reduce = {.type = \
TSParseActionTypeReduce, .symbol = sym_concatenation, child_count = 4, \
	.dynamic_precedence = 0, .production_id = 0}}};
	v->arr[1229] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1230] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (488)}}};
	init_pae87(v);
}
...
void	init_pae87(t_parse_action_entries *v)
{
	...
	v->arr[1232] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (5800)}}};
	v->arr[1233] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1234] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (492)}}};
...
TSParseActionTypeReduce, .symbol = sym_concatenation, child_count = 4, \
	...
	v->arr[1238] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (492)}}};
...
{
	v->arr[1244] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (506)}}};
	v->arr[1245] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1246] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (5734)}}};
	v->arr[1247] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1248] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (507)}}};
	v->arr[1249] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[1250] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (507)}}};
