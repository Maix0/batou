...
TSParseActionTypeReduce, .symbol = sym_file_redirect, child_count = 2, \
	...
	v->arr[2099] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (570)}}};
...
TSParseActionTypeReduce, symbol = aux_sym_declaration_command_repeat1, \
	...
	v->arr[2101] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1322), repetition = true}}};
	v->arr[2103] = (t_pae){.entry = {.count = 2, .reusable = false}};
	v->arr[2104] = (t_pae){.action = {reduce = {.type = \
TSParseActionTypeReduce, symbol = aux_sym_declaration_command_repeat1, \
	.child_count = 2, dynamic_precedence = 0, .production_id = 0}}};
	v->arr[2104] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
