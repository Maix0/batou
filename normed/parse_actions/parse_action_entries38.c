...
{
	v->arr[2533] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
...
{
	v->arr[2545] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
...
TSParseActionTypeReduce, .symbol = sym_unset_command, child_count = 2, \
	...
	v->arr[2567] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (598)}}};
	v->arr[2568] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2569] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1394)}}};
	init_pae193(v);
}
...
void	init_pae193(t_parse_action_entries *v)
{
	...
	v->arr[2571] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3849)}}};
	v->arr[2572] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2573] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3850)}}};
	v->arr[2574] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2575] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (6044)}}};
	v->arr[2576] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2577] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1468)}}};
	v->arr[2578] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2579] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (5777)}}};
	v->arr[2580] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2581] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1616)}}};
	v->arr[2582] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2583] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (6274)}}};
...
{
	v->arr[2585] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (4661)}}};
	v->arr[2586] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2587] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (292)}}};
	v->arr[2588] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2589] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (291)}}};
	v->arr[2590] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2591] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (288)}}};
	v->arr[2592] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2593] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (349)}}};
	v->arr[2594] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[2595] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1307)}}};
	v->arr[2596] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[2597] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (7667)}}};
	v->arr[2598] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2599] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1381)}}};
	init_pae195(v);
}
