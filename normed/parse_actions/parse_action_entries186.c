...
TSParseActionTypeReduce, .symbol = sym_case_item, child_count = 4, \
	...
	TSParseActionTypeShift, .state = (4059)}}};
...
TSParseActionTypeReduce, .symbol = sym_case_item, child_count = 4, \
	...
	TSParseActionTypeShift, .state = (4077)}}};
...
TSParseActionTypeReduce, symbol = aux_sym_concatenation_repeat1, .child_count = \
	...
	TSParseActionTypeShift, .state = (3866), repetition = true}}};
...
TSParseActionTypeReduce, symbol = aux_sym_redirected_statement_repeat2, \
	...
	TSParseActionTypeShift, .state = (3624), repetition = true}}};
