...
{
	v->arr[2203] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1362), repetition = true}}};
	v->arr[2205] = (t_pae){.entry = {.count = 2, .reusable = true}};
	v->arr[2206] = (t_pae){.action = {reduce = {.type = \
TSParseActionTypeReduce, symbol = aux_sym_declaration_command_repeat1, \
	.child_count = 2, dynamic_precedence = 0, .production_id = 0}}};
	v->arr[2206] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
...
TSParseActionTypeReduce, symbol = aux_sym_for_statement_repeat1, .child_count = \
	...
	v->arr[2209] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1158), repetition = true}}};
	v->arr[2211] = (t_pae){.entry = {.count = 2, .reusable = false}};
	v->arr[2212] = (t_pae){.action = {reduce = {.type = \
TSParseActionTypeReduce, symbol = aux_sym_for_statement_repeat1, .child_count = \
	2, dynamic_precedence = 0, .production_id = 0}}};
	v->arr[2212] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
