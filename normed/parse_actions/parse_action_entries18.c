...
void	init_pae90(t_parse_action_entries *v)
{
	...
	v->arr[1270] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3771)}}};
...
{
	v->arr[1279] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (7273)}}};
...
{
	v->arr[1291] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3813)}}};
	v->arr[1292] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1293] = (t_pae){.action = {.reduce = {.type = \
ACT_TY_REDUCE, .symbol = sym_arithmetic_expansion, .child_count = 4, \
	.dynamic_precedence = 0, .production_id = 0}}};
...
ACT_TY_REDUCE, .symbol = sym_process_substitution, .child_count = 3, \
	.dynamic_precedence = 0, .production_id = 0}}};
...
ACT_TY_REDUCE, .symbol = sym_brace_expression, .child_count = 5, \
	.dynamic_precedence = 0, .production_id = 0}}};
	init_pae93(v);
}
...
ACT_TY_REDUCE, .symbol = sym_command_substitution, .child_count = 3, \
...
ACT_TY_REDUCE, .symbol = sym_expansion, .child_count = 3, \
...
ACT_TY_REDUCE, .symbol = sym_number, .child_count = 1, \
	.dynamic_precedence = 0, .production_id = 0}}};
...
ACT_TY_REDUCE, .symbol = sym_string, .child_count = 2, \
	.dynamic_precedence = 0, .production_id = 0}}};
