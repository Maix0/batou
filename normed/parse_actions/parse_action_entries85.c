...
void	init_pae425(t_parse_action_entries *v)
{
	...
	v->arr[5649] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4168)}}};
	v->arr[5650] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5651] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4023)}}};
	v->arr[5652] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5653] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1724)}}};
	v->arr[5654] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5655] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4168)}}};
...
ACT_TY_REDUCE, .symbol = aux_sym_concatenation_repeat1, .child_count = \
	...
	v->arr[5657] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
...
{
	v->arr[5660] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3951), .repetition = true}}};
	v->arr[5662] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5663] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1551)}}};
	v->arr[5664] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5665] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3798)}}};
	v->arr[5666] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5667] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3798)}}};
	v->arr[5668] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5669] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4086)}}};
...
ACT_TY_REDUCE, .symbol = aux_sym__literal_repeat1, .child_count = 2, \
	...
	v->arr[5671] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
