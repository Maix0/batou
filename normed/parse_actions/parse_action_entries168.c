...
void	init_pae840(t_parse_action_entries *v)
{
	...
	TSParseActionTypeShift, .state = (3953), repetition = true}}};
...
TSParseActionTypeReduce, symbol = aux_sym_concatenation_repeat1, .child_count = \
	...
	TSParseActionTypeShift, .state = (4180)}}};
...
TSParseActionTypeReduce, symbol = aux_sym_concatenation_repeat1, .child_count = \
	...
	TSParseActionTypeShift, .state = (4788)}}};
...
TSParseActionTypeReduce, symbol = aux_sym__literal_repeat1, .child_count = 2, \
	...
	TSParseActionTypeShift, .state = (4788), repetition = true}}};
