...
{
	v->arr[1457] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (969)}}};
	v->arr[1458] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1459] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (5788)}}};
	v->arr[1460] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1461] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1155)}}};
	v->arr[1462] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1463] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (6254)}}};
	v->arr[1464] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1465] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (4675)}}};
	v->arr[1466] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1467] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (305)}}};
	v->arr[1468] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1469] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (304)}}};
	v->arr[1470] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1471] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (303)}}};
	init_pae106(v);
}
...
void	init_pae106(t_parse_action_entries *v)
{
	...
	v->arr[1473] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (372)}}};
	v->arr[1474] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[1475] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1003)}}};
	v->arr[1476] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[1477] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1328)}}};
	v->arr[1478] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[1479] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (7664)}}};
...
TSParseActionTypeReduce, symbol = aux_sym_command_repeat2, .child_count = 2, \
	...
	v->arr[1481] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
...
{
	v->arr[1484] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
...
TSParseActionTypeReduce, symbol = aux_sym_command_repeat2, .child_count = 2, \
	dynamic_precedence = 0, .production_id = 38}}};
	v->arr[1489] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
...
TSParseActionTypeReduce, symbol = aux_sym_command_repeat2, .child_count = 2, \
	dynamic_precedence = 0, .production_id = 38}}};
	v->arr[1494] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
