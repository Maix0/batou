...
{
	v->arr[2855] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (7655), .repetition = true}}};
	v->arr[2857] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2858] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4240)}}};
	v->arr[2859] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2860] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3714)}}};
	v->arr[2861] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2862] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3713)}}};
	v->arr[2863] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2864] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (6030)}}};
	v->arr[2865] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2866] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4218)}}};
	v->arr[2867] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2868] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5807)}}};
	v->arr[2869] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2870] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4399)}}};
	init_pae216(v);
}
...
void	init_pae216(t_parse_action_entries *v)
{
	...
	v->arr[2872] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (6341)}}};
	v->arr[2873] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2874] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4681)}}};
	v->arr[2875] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2876] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (323)}}};
	v->arr[2877] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2878] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (322)}}};
	v->arr[2879] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2880] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (321)}}};
	v->arr[2881] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2882] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (397)}}};
	v->arr[2883] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[2884] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4252)}}};
...
{
	v->arr[2886] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (7658)}}};
	v->arr[2887] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2888] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (629)}}};
