...
{
	v->arr[6229] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1241)}}};
...
TSParseActionTypeReduce, symbol = aux_sym_redirected_statement_repeat2, \
	...
	v->arr[6232] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3505)}}};
	v->arr[6234] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6235] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (4089)}}};
	v->arr[6236] = (t_pae){.entry = {.count = 2, .reusable = false}};
	v->arr[6237] = (t_pae){.action = {reduce = {.type = \
TSParseActionTypeReduce, symbol = aux_sym_redirected_statement_repeat2, \
	.child_count = 1, dynamic_precedence = 0, .production_id = 0}}};
	v->arr[6237] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (6226)}}};
	v->arr[6239] = (t_pae){.entry = {.count = 2, .reusable = false}};
	v->arr[6240] = (t_pae){.action = {reduce = {.type = \
TSParseActionTypeReduce, symbol = aux_sym_redirected_statement_repeat2, \
	.child_count = 1, dynamic_precedence = 0, .production_id = 0}}};
	v->arr[6240] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (5433)}}};
	init_pae471(v);
}
...
TSParseActionTypeReduce, symbol = aux_sym_redirected_statement_repeat2, \
	.child_count = 1, dynamic_precedence = 0, .production_id = 0}}};
	v->arr[6243] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1255)}}};
	v->arr[6245] = (t_pae){.entry = {.count = 2, .reusable = false}};
	v->arr[6246] = (t_pae){.action = {reduce = {.type = \
TSParseActionTypeReduce, symbol = aux_sym_redirected_statement_repeat2, \
	.child_count = 1, dynamic_precedence = 0, .production_id = 0}}};
	v->arr[6246] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (5524)}}};
	v->arr[6248] = (t_pae){.entry = {.count = 2, .reusable = false}};
	v->arr[6249] = (t_pae){.action = {reduce = {.type = \
TSParseActionTypeReduce, symbol = aux_sym_redirected_statement_repeat2, \
	.child_count = 1, dynamic_precedence = 0, .production_id = 0}}};
	v->arr[6249] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2919)}}};
...
{
	v->arr[6252] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (856)}}};
	v->arr[6254] = (t_pae){.entry = {.count = 2, .reusable = false}};
	v->arr[6255] = (t_pae){.action = {reduce = {.type = \
TSParseActionTypeReduce, symbol = aux_sym_redirected_statement_repeat2, \
	.child_count = 1, dynamic_precedence = 0, .production_id = 0}}};
	v->arr[6255] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2909)}}};
	v->arr[6257] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[6258] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2305)}}};
	v->arr[6259] = (t_pae){.entry = {.count = 2, .reusable = false}};
	v->arr[6260] = (t_pae){.action = {reduce = {.type = \
TSParseActionTypeReduce, symbol = aux_sym_redirected_statement_repeat2, \
	.child_count = 1, dynamic_precedence = 0, .production_id = 0}}};
	v->arr[6260] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2669)}}};
	v->arr[6262] = (t_pae){.entry = {.count = 2, .reusable = false}};
	v->arr[6263] = (t_pae){.action = {reduce = {.type = \
TSParseActionTypeReduce, symbol = aux_sym_redirected_statement_repeat2, \
	.child_count = 1, dynamic_precedence = 0, .production_id = 0}}};
	v->arr[6263] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (5669)}}};
	init_pae473(v);
}
...
TSParseActionTypeReduce, symbol = aux_sym_redirected_statement_repeat2, \
	.child_count = 1, dynamic_precedence = 0, .production_id = 0}}};
	v->arr[6266] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3253)}}};
	v->arr[6268] = (t_pae){.entry = {.count = 2, .reusable = false}};
	v->arr[6269] = (t_pae){.action = {reduce = {.type = \
TSParseActionTypeReduce, symbol = aux_sym_redirected_statement_repeat2, \
	.child_count = 1, dynamic_precedence = 0, .production_id = 0}}};
	v->arr[6269] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (6436)}}};
	v->arr[6271] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6272] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (4140)}}};
	v->arr[6273] = (t_pae){.entry = {.count = 2, .reusable = false}};
	v->arr[6274] = (t_pae){.action = {reduce = {.type = \
TSParseActionTypeReduce, symbol = aux_sym_redirected_statement_repeat2, \
	.child_count = 1, dynamic_precedence = 0, .production_id = 0}}};
	v->arr[6274] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2527)}}};
...
TSParseActionTypeReduce, symbol = aux_sym_redirected_statement_repeat2, \
	.child_count = 1, dynamic_precedence = 0, .production_id = 0}}};
	v->arr[6277] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (6555)}}};
	v->arr[6279] = (t_pae){.entry = {.count = 2, .reusable = false}};
	v->arr[6280] = (t_pae){.action = {reduce = {.type = \
TSParseActionTypeReduce, symbol = aux_sym_redirected_statement_repeat2, \
	.child_count = 1, dynamic_precedence = 0, .production_id = 0}}};
	v->arr[6280] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2530)}}};
	v->arr[6282] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[6283] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2338)}}};
	v->arr[6284] = (t_pae){.entry = {.count = 2, .reusable = false}};
	v->arr[6285] = (t_pae){.action = {reduce = {.type = \
TSParseActionTypeReduce, symbol = aux_sym_redirected_statement_repeat2, \
	.child_count = 1, dynamic_precedence = 0, .production_id = 0}}};
	v->arr[6285] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3172)}}};
