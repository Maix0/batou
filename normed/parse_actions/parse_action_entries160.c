...
void	init_pae800(t_parse_action_entries *v)
{
	...
	TSParseActionTypeShift, .state = (4897)}}};
	init_pae801(v);
}
...
void	init_pae801(t_parse_action_entries *v)
{
	...
	TSParseActionTypeShift, .state = (6198)}}};
	...
	TSParseActionTypeShift, .state = (4822)}}};
...
void	init_pae802(t_parse_action_entries *v)
{
	...
	TSParseActionTypeShift, .state = (4750)}}};
...
void	init_pae803(t_parse_action_entries *v)
{
	...
	TSParseActionTypeShift, .state = (1758)}}};
