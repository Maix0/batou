...
void	init_pae445(t_parse_action_entries *v)
{
	...
	v->arr[5913] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5584)}}};
	v->arr[5914] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5915] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4094)}}};
	v->arr[5916] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5917] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2374)}}};
	v->arr[5918] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5919] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1312)}}};
	v->arr[5920] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5921] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3837)}}};
	v->arr[5922] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5923] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3767)}}};
	v->arr[5924] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5925] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3773)}}};
...
{
	v->arr[5927] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1648)}}};
	v->arr[5928] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5929] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1835)}}};
	v->arr[5930] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5931] = (t_pae){.action = {.reduce = {.type = \
ACT_TY_REDUCE, .symbol = sym_negated_command, .child_count = 2, \
...
ACT_TY_REDUCE, .symbol = aux_sym_concatenation_repeat1, .child_count = \
	...
	v->arr[5935] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
...
{
	v->arr[5964] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4003)}}};
