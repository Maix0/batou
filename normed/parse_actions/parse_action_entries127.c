...
void	init_pae635(t_parse_action_entries *v)
{
	...
	v->arr[8543] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (7636)}}};
...
ACT_TY_REDUCE, .symbol = sym__expansion_body, .child_count = 1, \
	...
	v->arr[8547] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (6176)}}};
...
ACT_TY_REDUCE, .symbol = sym__expansion_body, .child_count = 2, \
	...
	v->arr[8553] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3552)}}};
...
{
	v->arr[8555] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5269)}}};
	v->arr[8556] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[8557] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5797)}}};
	v->arr[8558] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[8559] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5279)}}};
	v->arr[8560] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8561] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5279)}}};
...
ACT_TY_REDUCE, .symbol = aux_sym__literal_repeat1, .child_count = 2, \
	.dynamic_precedence = 0, .production_id = 0}}};
	v->arr[8563] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3552), .repetition = true}}};
	v->arr[8565] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[8566] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5045)}}};
	v->arr[8567] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8568] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4012)}}};
	init_pae637(v);
}
...
void	init_pae637(t_parse_action_entries *v)
{
	...
	v->arr[8570] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2173)}}};
	v->arr[8571] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8572] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4008)}}};
	v->arr[8573] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[8574] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5903)}}};
	v->arr[8575] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8576] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5097)}}};
	v->arr[8577] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8578] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5762)}}};
	v->arr[8579] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8580] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5045)}}};
	v->arr[8581] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[8582] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5149)}}};
...
{
	v->arr[8584] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (6336)}}};
	v->arr[8585] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8586] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4850)}}};
	v->arr[8587] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[8588] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (89)}}};
	v->arr[8589] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8590] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (97)}}};
	v->arr[8591] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8592] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (98)}}};
	v->arr[8593] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8594] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (355)}}};
	v->arr[8595] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8596] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5041)}}};
	v->arr[8597] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8598] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (7631)}}};
	init_pae639(v);
}
...
void	init_pae639(t_parse_action_entries *v)
{
	...
	v->arr[8600] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2913)}}};
	v->arr[8601] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8602] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2884)}}};
	v->arr[8603] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8604] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3578)}}};
	v->arr[8605] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8606] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3597)}}};
	v->arr[8607] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8608] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1574)}}};
	v->arr[8609] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8610] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1542)}}};
	v->arr[8611] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[8612] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (6338)}}};
