...
{
	v->arr[1588] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5884)}}};
	v->arr[1589] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1590] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1144)}}};
	v->arr[1591] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1592] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5746)}}};
	v->arr[1593] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1594] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1272)}}};
	v->arr[1595] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1596] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (6309)}}};
	v->arr[1597] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1598] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4841)}}};
	v->arr[1599] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1600] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (205)}}};
	v->arr[1601] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1602] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (206)}}};
	init_pae116(v);
}
...
void	init_pae116(t_parse_action_entries *v)
{
	...
	v->arr[1604] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (207)}}};
	v->arr[1605] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1606] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (189)}}};
	v->arr[1607] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[1608] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1094)}}};
	v->arr[1609] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[1610] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1521)}}};
	v->arr[1611] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[1612] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (7613)}}};
...
void	init_pae117(t_parse_action_entries *v)
{
	...
	v->arr[1618] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (888)}}};
	v->arr[1619] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1620] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5840)}}};
	v->arr[1621] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1622] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (889)}}};
	v->arr[1623] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[1624] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (889)}}};
