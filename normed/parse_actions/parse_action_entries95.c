...
{
	v->arr[6288] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (6242)}}};
...
ACT_TY_REDUCE, .symbol = aux_sym_redirected_statement_repeat2, \
	...
	v->arr[6291] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4402)}}};
	v->arr[6293] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[6294] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2497)}}};
	v->arr[6295] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6296] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2497)}}};
	v->arr[6297] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6298] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (461)}}};
	v->arr[6299] = (t_pae){.entry = {.count = 2, .reusable = false}};
	v->arr[6300] = (t_pae){.action = {.reduce = {.type = \
ACT_TY_REDUCE, .symbol = aux_sym_redirected_statement_repeat2, \
	.child_count = 1, .dynamic_precedence = 0, .production_id = 0}}};
	v->arr[6300] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (6532)}}};
	init_pae476(v);
}
