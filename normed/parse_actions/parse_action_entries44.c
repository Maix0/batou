...
{
	v->arr[2920] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
...
void	init_pae222(t_parse_action_entries *v)
{
	...
	v->arr[2948] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1418)}}};
	v->arr[2949] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2950] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1709)}}};
	v->arr[2951] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2952] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1701)}}};
	v->arr[2953] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[2954] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1701)}}};
	v->arr[2955] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2956] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1253)}}};
	v->arr[2957] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2958] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1252)}}};
	v->arr[2959] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[2960] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1252)}}};
...
{
	v->arr[2962] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1717)}}};
	v->arr[2963] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2964] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1427)}}};
	v->arr[2965] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2966] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5796)}}};
	v->arr[2967] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2968] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1428)}}};
	v->arr[2969] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[2970] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1428)}}};
	v->arr[2971] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2972] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (852)}}};
...
ACT_TY_REDUCE, .symbol = aux_sym_for_statement_repeat1, .child_count = \
	2, .dynamic_precedence = 0, .production_id = 0}}};
	v->arr[2974] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
