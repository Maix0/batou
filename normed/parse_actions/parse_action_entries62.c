...
{
	v->arr[4124] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4524)}}};
	v->arr[4125] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4126] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4733)}}};
	v->arr[4127] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[4128] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4479)}}};
	v->arr[4129] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4130] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4488)}}};
	v->arr[4131] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[4132] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1968)}}};
	v->arr[4133] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[4134] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2074)}}};
	v->arr[4135] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4136] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1972)}}};
	v->arr[4137] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[4138] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4834)}}};
	init_pae311(v);
}
...
void	init_pae311(t_parse_action_entries *v)
{
	...
	v->arr[4140] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4495)}}};
	v->arr[4141] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4142] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4816)}}};
	v->arr[4143] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[4144] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4838)}}};
	v->arr[4145] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4146] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4835)}}};
	v->arr[4147] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[4148] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2419)}}};
	v->arr[4149] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4150] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4114)}}};
	v->arr[4151] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4152] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4112)}}};
...
{
	v->arr[4154] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5894)}}};
	v->arr[4155] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4156] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2373)}}};
	v->arr[4157] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4158] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5754)}}};
	v->arr[4159] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4160] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2419)}}};
	v->arr[4161] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[4162] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2469)}}};
	v->arr[4163] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[4164] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (6298)}}};
	v->arr[4165] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4166] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4730)}}};
	v->arr[4167] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[4168] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (278)}}};
	init_pae313(v);
}
...
void	init_pae313(t_parse_action_entries *v)
{
	...
	v->arr[4170] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (136)}}};
	v->arr[4171] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4172] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (289)}}};
	v->arr[4173] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4174] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (248)}}};
	v->arr[4175] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[4176] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (803)}}};
	v->arr[4177] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4178] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (6636)}}};
	v->arr[4179] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4180] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2395)}}};
	v->arr[4181] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4182] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (7623)}}};
...
{
	v->arr[4184] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4692)}}};
	v->arr[4185] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4186] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4689)}}};
	v->arr[4187] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[4188] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (797)}}};
