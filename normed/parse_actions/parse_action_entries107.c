...
TSParseActionTypeReduce, symbol = sym__arithmetic_postfix_expression, \
	.child_count = 2, dynamic_precedence = 0, .production_id = 27}}};
	v->arr[7108] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[7109] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (7362)}}};
	v->arr[7110] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[7111] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1570)}}};
	v->arr[7112] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[7113] = (t_pae){.action = {reduce = {.type = \
TSParseActionTypeReduce, symbol = sym__arithmetic_parenthesized_expression, \
...
TSParseActionTypeReduce, symbol = sym__arithmetic_parenthesized_expression, \
	...
	v->arr[7117] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3058)}}};
...
{
	v->arr[7119] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3049)}}};
...
TSParseActionTypeReduce, symbol = aux_sym__literal_repeat1, .child_count = 2, \
	...
	v->arr[7121] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3055), repetition = true}}};
	v->arr[7123] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[7124] = (t_pae){.action = {reduce = {.type = \
TSParseActionTypeReduce, symbol = sym_ternary_expression, .child_count = 5, \
...
TSParseActionTypeReduce, symbol = sym_ternary_expression, .child_count = 5, \
	...
	v->arr[7128] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (6962)}}};
	v->arr[7129] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[7130] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2355)}}};
	init_pae537(v);
}
...
void	init_pae537(t_parse_action_entries *v)
{
	...
	v->arr[7132] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (4588)}}};
	v->arr[7133] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[7134] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (4590)}}};
	v->arr[7135] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[7136] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (4590)}}};
	v->arr[7137] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[7138] = (t_pae){.action = {reduce = {.type = \
TSParseActionTypeReduce, symbol = sym__arithmetic_binary_expression, \
...
TSParseActionTypeReduce, symbol = sym__arithmetic_binary_expression, \
	...
	v->arr[7142] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (4384)}}};
	v->arr[7143] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[7144] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (5799)}}};
	init_pae538(v);
}
...
void	init_pae538(t_parse_action_entries *v)
{
	...
	v->arr[7146] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (4385)}}};
	v->arr[7147] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[7148] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (4385)}}};
	v->arr[7149] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[7150] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (4469)}}};
	v->arr[7151] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[7152] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (4470)}}};
	v->arr[7153] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[7154] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (4470)}}};
	v->arr[7155] = (t_pae){.entry = {.count = 2, .reusable = true}};
	v->arr[7156] = (t_pae){.action = {reduce = {.type = \
TSParseActionTypeReduce, symbol = aux_sym__literal_repeat1, .child_count = 2, \
	dynamic_precedence = 0, .production_id = 0}}};
	v->arr[7156] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
...
{
	v->arr[7159] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3055)}}};
	v->arr[7160] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[7161] = (t_pae){.action = {reduce = {.type = \
TSParseActionTypeReduce, .symbol = sym_subscript, child_count = 6, \
...
TSParseActionTypeReduce, .symbol = sym_subscript, child_count = 6, \
	...
	v->arr[7169] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1143)}}};
