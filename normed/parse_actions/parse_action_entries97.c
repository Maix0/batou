...
void	init_pae485(t_parse_action_entries *v)
{
	...
	v->arr[6410] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2549)}}};
	v->arr[6411] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6412] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2549)}}};
	v->arr[6413] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6414] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (455)}}};
	v->arr[6415] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[6416] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2455)}}};
	v->arr[6417] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6418] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2455)}}};
	v->arr[6419] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6420] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (462)}}};
...
{
	v->arr[6422] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
...
{
	v->arr[6434] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (6538)}}};
	v->arr[6436] = (t_pae){.entry = {.count = 2, .reusable = false}};
	v->arr[6437] = (t_pae){.action = {.reduce = {.type = \
ACT_TY_REDUCE, .symbol = aux_sym_redirected_statement_repeat2, \
	.child_count = 1, .dynamic_precedence = 0, .production_id = 0}}};
	v->arr[6437] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (6147)}}};
	v->arr[6439] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[6440] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2418)}}};
	v->arr[6441] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6442] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3717)}}};
	v->arr[6443] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[6444] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2381)}}};
	v->arr[6445] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6446] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3826)}}};
	v->arr[6447] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6448] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3928)}}};
	init_pae488(v);
}
...
void	init_pae488(t_parse_action_entries *v)
{
	...
	v->arr[6450] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3887)}}};
