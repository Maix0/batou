...
{
	v->arr[1852] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (565)}}};
	v->arr[1853] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[1854] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (6628)}}};
	v->arr[1855] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[1856] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1170)}}};
	v->arr[1857] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[1858] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (7662)}}};
...
TSParseActionTypeReduce, symbol = aux_sym_command_repeat2, .child_count = 2, \
	...
	v->arr[1860] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1023), repetition = true}}};
	v->arr[1862] = (t_pae){.entry = {.count = 2, .reusable = false}};
	v->arr[1863] = (t_pae){.action = {reduce = {.type = \
TSParseActionTypeReduce, symbol = aux_sym_command_repeat2, .child_count = 2, \
	dynamic_precedence = 0, .production_id = 38}}};
	v->arr[1863] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
