...
{
	v->arr[4978] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2480)}}};
	v->arr[4979] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4980] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2578)}}};
	v->arr[4981] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4982] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4133)}}};
...
{
	v->arr[4990] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2578), .repetition = true}}};
	v->arr[4992] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4993] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4129)}}};
