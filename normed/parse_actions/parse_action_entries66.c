...
ACT_TY_REDUCE, .symbol = aux_sym_command_repeat1, .child_count = 1, \
	...
	v->arr[4387] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (6619)}}};
	v->arr[4389] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[4390] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3940)}}};
	v->arr[4391] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4392] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3984)}}};
	v->arr[4393] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4394] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3988)}}};
	v->arr[4395] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[4396] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2362)}}};
	v->arr[4397] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[4398] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5730)}}};
...
{
	v->arr[4400] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2363)}}};
	v->arr[4401] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4402] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2363)}}};
...
void	init_pae332(t_parse_action_entries *v)
{
	...
	v->arr[4414] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3940)}}};
