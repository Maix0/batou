...
{
	v->arr[3862] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
...
{
	v->arr[3874] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (7633), repetition = true}}};
	v->arr[3876] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3877] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1846)}}};
	v->arr[3878] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3879] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (4061)}}};
	v->arr[3880] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3881] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (4054)}}};
	v->arr[3882] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3883] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (5926)}}};
	v->arr[3884] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3885] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1916)}}};
	v->arr[3886] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3887] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1946)}}};
	v->arr[3888] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3889] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (6348)}}};
	init_pae292(v);
}
...
void	init_pae292(t_parse_action_entries *v)
{
	...
	v->arr[3891] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (4819)}}};
	v->arr[3892] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3893] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (374)}}};
	v->arr[3894] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3895] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (410)}}};
	v->arr[3896] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3897] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (247)}}};
	v->arr[3898] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3899] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (272)}}};
	v->arr[3900] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[3901] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1845)}}};
	v->arr[3902] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[3903] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (7627)}}};
...
{
	v->arr[3905] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (6466)}}};
	v->arr[3906] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[3907] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (6411)}}};
