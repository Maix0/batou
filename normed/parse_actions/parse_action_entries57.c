...
void	init_pae285(t_parse_action_entries *v)
{
	...
	v->arr[3800] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (79)}}};
	v->arr[3801] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3802] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (80)}}};
	v->arr[3803] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3804] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (83)}}};
	v->arr[3805] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3806] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (350)}}};
	v->arr[3807] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[3808] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4529)}}};
	v->arr[3809] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[3810] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (7630)}}};
	v->arr[3811] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3812] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3365)}}};
...
{
	v->arr[3814] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (6442)}}};
	v->arr[3815] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3816] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4518)}}};
	v->arr[3817] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3818] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4401)}}};
	v->arr[3819] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[3820] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4599)}}};
	v->arr[3821] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3822] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4486)}}};
	v->arr[3823] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[3824] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4484)}}};
	v->arr[3825] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3826] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1484)}}};
	v->arr[3827] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3828] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1492)}}};
	init_pae287(v);
}
...
void	init_pae287(t_parse_action_entries *v)
{
	...
	v->arr[3830] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1492)}}};
