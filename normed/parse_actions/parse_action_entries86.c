...
{
	v->arr[5712] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (4100)}}};
	v->arr[5713] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5714] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3770)}}};
	v->arr[5715] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5716] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3181)}}};
	v->arr[5717] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5718] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3177)}}};
	v->arr[5719] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5720] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3177)}}};
...
TSParseActionTypeReduce, symbol = aux_sym__literal_repeat1, .child_count = 2, \
	...
	v->arr[5726] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1551), repetition = true}}};
	v->arr[5728] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5729] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3868)}}};
	v->arr[5730] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5731] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (4161)}}};
	v->arr[5732] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5733] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3872)}}};
	v->arr[5734] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5735] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3747)}}};
...
{
	v->arr[5737] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
...
TSParseActionTypeReduce, symbol = aux_sym_concatenation_repeat1, .child_count = \
	2, dynamic_precedence = 0, .production_id = 0}}};
	v->arr[5751] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (4065), repetition = true}}};
	v->arr[5753] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5754] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1844)}}};
	v->arr[5755] = (t_pae){.entry = {.count = 2, .reusable = false}};
	v->arr[5756] = (t_pae){.action = {reduce = {.type = \
TSParseActionTypeReduce, symbol = aux_sym__literal_repeat1, .child_count = 2, \
	dynamic_precedence = 0, .production_id = 0}}};
	v->arr[5756] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1890), repetition = true}}};
	v->arr[5758] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5759] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3948)}}};
	v->arr[5760] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5761] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3948)}}};
...
{
	v->arr[5763] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (4127)}}};
	v->arr[5764] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5765] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (4106)}}};
	v->arr[5766] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5767] = (t_pae){.action = {reduce = {.type = \
TSParseActionTypeReduce, .symbol = sym_array, child_count = 3, \
	.dynamic_precedence = 0, .production_id = 0}}};
...
TSParseActionTypeReduce, .symbol = sym_array, child_count = 2, \
	.dynamic_precedence = 0, .production_id = 0}}};
