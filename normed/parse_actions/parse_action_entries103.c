...
void	init_pae515(t_parse_action_entries *v)
{
	...
	v->arr[6823] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2931)}}};
...
ACT_TY_REDUCE, .symbol = aux_sym__literal_repeat1, .child_count = 2, \
	...
	v->arr[6825] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
...
ACT_TY_REDUCE, .symbol = sym_subscript, .child_count = 5, \
	...
	v->arr[6832] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2930)}}};
...
ACT_TY_REDUCE, .symbol = sym_subscript, .child_count = 4, \
	...
	v->arr[6841] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2929)}}};
...
{
	v->arr[6847] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2926)}}};
	v->arr[6848] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[6849] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4307)}}};
	v->arr[6850] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[6851] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4308)}}};
	v->arr[6852] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6853] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4308)}}};
	v->arr[6854] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[6855] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2819)}}};
	v->arr[6856] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[6857] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2928)}}};
	v->arr[6858] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6859] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3856)}}};
	v->arr[6860] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6861] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3858)}}};
	init_pae518(v);
}
...
ACT_TY_REDUCE, .symbol = sym__extglob_blob, .child_count = 3, \
	.dynamic_precedence = 0, .production_id = 0}}};
...
ACT_TY_REDUCE, .symbol = aux_sym__literal_repeat1, .child_count = 2, \
	.dynamic_precedence = 0, .production_id = 0}}};
	v->arr[6867] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2796), .repetition = true}}};
	v->arr[6869] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6870] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2839)}}};
	v->arr[6871] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[6872] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2054)}}};
	v->arr[6873] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[6874] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1963)}}};
	init_pae519(v);
}
...
void	init_pae519(t_parse_action_entries *v)
{
	...
	v->arr[6876] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2062)}}};
	v->arr[6877] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[6878] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2063)}}};
	v->arr[6879] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6880] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1666)}}};
	v->arr[6881] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6882] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4108)}}};
	v->arr[6883] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[6884] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3731)}}};
	v->arr[6885] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6886] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2849)}}};
	v->arr[6887] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6888] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4098)}}};
