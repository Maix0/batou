...
{
	v->arr[1518] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
...
void	init_pae112(t_parse_action_entries *v)
{
	...
	v->arr[1544] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4184)}}};
	v->arr[1545] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1546] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3686)}}};
	v->arr[1547] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1548] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3725)}}};
	v->arr[1549] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1550] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4183)}}};
	v->arr[1551] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1552] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5997)}}};
	v->arr[1553] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1554] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1091)}}};
	v->arr[1555] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1556] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5729)}}};
...
{
	v->arr[1558] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1268)}}};
	v->arr[1559] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1560] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (6350)}}};
	v->arr[1561] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1562] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4641)}}};
	v->arr[1563] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1564] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (249)}}};
	v->arr[1565] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1566] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (251)}}};
	v->arr[1567] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1568] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (253)}}};
	v->arr[1569] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1570] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (223)}}};
	v->arr[1571] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[1572] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1021)}}};
	init_pae114(v);
}
...
void	init_pae114(t_parse_action_entries *v)
{
	...
	v->arr[1574] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1716)}}};
	v->arr[1575] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[1576] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (7619)}}};
	v->arr[1577] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1578] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1093)}}};
	v->arr[1579] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1580] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4211)}}};
	v->arr[1581] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1582] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3695)}}};
	v->arr[1583] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1584] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3787)}}};
	v->arr[1585] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1586] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4212)}}};
