...
void	init_pae235(t_parse_action_entries *v)
{
	...
	v->arr[3118] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1771)}}};
	v->arr[3119] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[3120] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1771)}}};
	v->arr[3121] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3122] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1414)}}};
	v->arr[3123] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3124] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1419)}}};
	v->arr[3125] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[3126] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1419)}}};
...
ACT_TY_REDUCE, .symbol = aux_sym_unset_command_repeat1, .child_count = \
	...
	v->arr[3128] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
