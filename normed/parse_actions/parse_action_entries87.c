...
{
	v->arr[5775] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (4141)}}};
...
TSParseActionTypeReduce, symbol = aux_sym_command_repeat1, .child_count = 1, \
	...
	v->arr[5777] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (6686)}}};
	v->arr[5779] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5780] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2347)}}};
	v->arr[5781] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5782] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1173)}}};
...
TSParseActionTypeReduce, symbol = aux_sym_concatenation_repeat1, .child_count = \
	...
	v->arr[5784] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
...
{
	v->arr[5787] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (4127), repetition = true}}};
	v->arr[5789] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5790] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (4127)}}};
	v->arr[5791] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5792] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (5854)}}};
	v->arr[5793] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5794] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (4761)}}};
	v->arr[5795] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5796] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (413)}}};
	v->arr[5797] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5798] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (412)}}};
	v->arr[5799] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5800] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (411)}}};
...
{
	v->arr[5802] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1885), repetition = true}}};
	v->arr[5804] = (t_pae){.entry = {.count = 2, .reusable = false}};
	v->arr[5805] = (t_pae){.action = {reduce = {.type = \
TSParseActionTypeReduce, symbol = aux_sym__literal_repeat1, .child_count = 2, \
	dynamic_precedence = 0, .production_id = 0}}};
	v->arr[5805] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1844), repetition = true}}};
	v->arr[5807] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5808] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2382)}}};
	v->arr[5809] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5810] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (216)}}};
	v->arr[5811] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5812] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1603)}}};
	v->arr[5813] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5814] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3788)}}};
	v->arr[5815] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5816] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3788)}}};
	init_pae438(v);
}
...
void	init_pae438(t_parse_action_entries *v)
{
	...
	v->arr[5818] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1890)}}};
...
TSParseActionTypeReduce, symbol = aux_sym_command_repeat1, .child_count = 1, \
	...
	v->arr[5834] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3906)}}};
	v->arr[5835] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5836] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3914)}}};
	v->arr[5837] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5838] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (4158)}}};
	v->arr[5839] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5840] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (4162)}}};
	init_pae440(v);
}
