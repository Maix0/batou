...
void	init_pae847(t_parse_action_entries *v)
{
	...
	TSParseActionTypeShift, .state = (6152), repetition = true}}};
...
TSParseActionTypeReduce, symbol = aux_sym_variable_assignments_repeat1, \
	...
	TSParseActionTypeShift, .state = (6668), repetition = true}}};
...
TSParseActionTypeReduce, symbol = aux_sym_concatenation_repeat1, .child_count = \
	...
	TSParseActionTypeShift, .state = (3823), repetition = true}}};
...
TSParseActionTypeReduce, symbol = aux_sym_concatenation_repeat1, .child_count = \
	...
	TSParseActionTypeShift, .state = (3964)}}};
	init_pae848(v);
}
...
void	init_pae848(t_parse_action_entries *v)
{
	...
	TSParseActionTypeShift, .state = (3778)}}};
