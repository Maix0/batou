...
{
	v->arr[5104] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (6604)}}};
	v->arr[5106] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5107] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3745)}}};
	v->arr[5108] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5109] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2613)}}};
	v->arr[5110] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5111] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3835)}}};
	v->arr[5112] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5113] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3818)}}};
	v->arr[5114] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5115] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (6082)}}};
	v->arr[5116] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5117] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2632)}}};
	v->arr[5118] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5119] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5837)}}};
	init_pae386(v);
}
...
void	init_pae386(t_parse_action_entries *v)
{
	...
	v->arr[5121] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2613)}}};
	v->arr[5122] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5123] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2869)}}};
	v->arr[5124] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5125] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (6366)}}};
	v->arr[5126] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5127] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4737)}}};
	v->arr[5128] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5129] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (384)}}};
	v->arr[5130] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5131] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (383)}}};
	v->arr[5132] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5133] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (382)}}};
...
{
	v->arr[5135] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (210)}}};
	v->arr[5136] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5137] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2612)}}};
	v->arr[5138] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5139] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (7647)}}};
	v->arr[5140] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5141] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (827)}}};
	v->arr[5142] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5143] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (827)}}};
	v->arr[5144] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5145] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4034)}}};
	v->arr[5146] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5147] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4034)}}};
	v->arr[5148] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5149] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3750)}}};
	init_pae388(v);
}
...
void	init_pae388(t_parse_action_entries *v)
{
	...
	v->arr[5151] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2468)}}};
	v->arr[5152] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5153] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5754)}}};
	v->arr[5154] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5155] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2467)}}};
	v->arr[5156] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5157] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2467)}}};
	v->arr[5158] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5159] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2625)}}};
	v->arr[5160] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5161] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2624)}}};
	v->arr[5162] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5163] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2624)}}};
...
{
	v->arr[5165] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4019)}}};
	v->arr[5166] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5167] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4020)}}};
