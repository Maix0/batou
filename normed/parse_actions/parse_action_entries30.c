...
{
	v->arr[2030] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (7613), repetition = true}}};
	v->arr[2032] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2033] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1322)}}};
	v->arr[2034] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2035] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (4200)}}};
	v->arr[2036] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2037] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (4204)}}};
	v->arr[2038] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2039] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (6034)}}};
	v->arr[2040] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2041] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1460)}}};
	v->arr[2042] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2043] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (5722)}}};
	v->arr[2044] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2045] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1580)}}};
	init_pae151(v);
}
...
void	init_pae151(t_parse_action_entries *v)
{
	...
	v->arr[2047] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (6321)}}};
	v->arr[2048] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2049] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (4765)}}};
	v->arr[2050] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2051] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (174)}}};
	v->arr[2052] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2053] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (175)}}};
	v->arr[2054] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2055] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (176)}}};
	v->arr[2056] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2057] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (177)}}};
	v->arr[2058] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2059] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (577)}}};
...
{
	v->arr[2061] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (6704)}}};
	v->arr[2062] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[2063] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1318)}}};
	v->arr[2064] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[2065] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (7611)}}};
	v->arr[2066] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2067] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1287)}}};
	v->arr[2068] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2069] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1289)}}};
	v->arr[2070] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[2071] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1289)}}};
