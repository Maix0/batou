...
void	init_pae169(t_parse_action_entries *v)
{
	...
	v->arr[2264] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (6071)}}};
	v->arr[2265] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2266] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1356)}}};
	v->arr[2267] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2268] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (5758)}}};
	v->arr[2269] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2270] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1571)}}};
	v->arr[2271] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2272] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (6343)}}};
	v->arr[2273] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2274] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (4649)}}};
	v->arr[2275] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2276] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (236)}}};
