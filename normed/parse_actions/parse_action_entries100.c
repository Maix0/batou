...
{
	v->arr[6619] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3109)}}};
	v->arr[6620] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[6621] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3106)}}};
	v->arr[6622] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[6623] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (4884)}}};
	v->arr[6624] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6625] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3106)}}};
	v->arr[6626] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[6627] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3105)}}};
	v->arr[6628] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[6629] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (4883)}}};
	v->arr[6630] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6631] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3105)}}};
	v->arr[6632] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6633] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (4113)}}};
	init_pae501(v);
}
...
TSParseActionTypeReduce, symbol = aux_sym_concatenation_repeat1, .child_count = \
	...
	v->arr[6635] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3869), repetition = true}}};
	v->arr[6637] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6638] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3961)}}};
	v->arr[6639] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[6640] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3136)}}};
	v->arr[6641] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[6642] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (5076)}}};
	v->arr[6643] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6644] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3136)}}};
	v->arr[6645] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6646] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3949)}}};
...
TSParseActionTypeReduce, symbol = aux_sym_concatenation_repeat1, .child_count = \
	2, dynamic_precedence = 0, .production_id = 0}}};
	v->arr[6648] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3732), repetition = true}}};
	v->arr[6650] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6651] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (4117)}}};
	v->arr[6652] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[6653] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2584)}}};
	v->arr[6654] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6655] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (7177)}}};
	v->arr[6656] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6657] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3738)}}};
	v->arr[6658] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6659] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2984)}}};
	v->arr[6660] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6661] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3668)}}};
	init_pae503(v);
}
...
void	init_pae503(t_parse_action_entries *v)
{
	...
	v->arr[6663] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2725)}}};
	v->arr[6664] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6665] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3885)}}};
	v->arr[6666] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6667] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3938)}}};
	v->arr[6668] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6669] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3865)}}};
	v->arr[6670] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6671] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (6609)}}};
	v->arr[6672] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6673] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3663)}}};
	v->arr[6674] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6675] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (7363)}}};
...
TSParseActionTypeReduce, symbol = aux_sym_concatenation_repeat1, .child_count = \
	2, dynamic_precedence = 0, .production_id = 0}}};
	v->arr[6677] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3929), repetition = true}}};
	v->arr[6679] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6680] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (4029)}}};
	v->arr[6681] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6682] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3980)}}};
	v->arr[6683] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6684] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3979)}}};
	v->arr[6685] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6686] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (4022)}}};
...
TSParseActionTypeReduce, symbol = aux_sym__literal_repeat1, .child_count = 2, \
	...
	v->arr[6688] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
