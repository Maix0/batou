...
void	init_pae1050(t_parse_action_entries *v)
{
	...
	TSParseActionTypeShift, .state = (5212)}}};
...
TSParseActionTypeReduce, symbol = sym__expansion_max_length_binary_expression, \
...
void	init_pae1051(t_parse_action_entries *v)
{
	...
	TSParseActionTypeShift, .state = (5211)}}};
...
TSParseActionTypeReduce, symbol = sym__expansion_max_length, .child_count = 4, \
	...
	TSParseActionTypeShift, .state = (243)}}};
...
void	init_pae1054(t_parse_action_entries *v)
{
	...
	TSParseActionTypeShift, .state = (226)}}};
