...
TSParseActionTypeReduce, symbol = aux_sym_redirected_statement_repeat1, \
	...
	TSParseActionTypeShift, .state = (1117), repetition = true}}};
...
TSParseActionTypeReduce, symbol = aux_sym_redirected_statement_repeat1, \
	...
	TSParseActionTypeShift, .state = (6104), repetition = true}}};
...
void	init_pae938(t_parse_action_entries *v)
{
	...
	TSParseActionTypeShift, .state = (6664), repetition = true}}};
...
TSParseActionTypeReduce, symbol = aux_sym__literal_repeat1, .child_count = 2, \
	...
	TSParseActionTypeShift, .state = (5410), repetition = true}}};
	v->arr[12818] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[12819] = (t_pae){.action = {.shift = {.type = \
	TSParseActionTypeShift, .state = (4203)}}};
...
TSParseActionTypeReduce, .symbol = sym_case_item, child_count = 5, \
	...
	TSParseActionTypeShift, .state = (3795)}}};
	init_pae939(v);
}
...
void	init_pae939(t_parse_action_entries *v)
{
	...
	TSParseActionTypeShift, .state = (3796)}}};
...
TSParseActionTypeReduce, .symbol = sym_case_item, child_count = 4, \
	...
	TSParseActionTypeShift, .state = (3629)}}};
