...
TSParseActionTypeReduce, symbol = sym__expansion_regex_replacement, \
	...
	TSParseActionTypeShift, .state = (6791)}}};
	init_pae1066(v);
}
...
TSParseActionTypeReduce, symbol = aux_sym__expansion_regex_repeat1, \
	...
	TSParseActionTypeShift, .state = (384)}}};
	init_pae1069(v);
}
