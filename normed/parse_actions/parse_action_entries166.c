...
TSParseActionTypeReduce, symbol = aux_sym_redirected_statement_repeat1, \
	...
	TSParseActionTypeShift, .state = (3635), repetition = true}}};
...
TSParseActionTypeReduce, symbol = aux_sym_redirected_statement_repeat1, \
	...
	TSParseActionTypeShift, .state = (6100), repetition = true}}};
...
TSParseActionTypeReduce, symbol = aux_sym_variable_assignments_repeat1, \
	...
	TSParseActionTypeShift, .state = (6619), repetition = true}}};
...
void	init_pae834(t_parse_action_entries *v)
{
	...
	TSParseActionTypeShift, .state = (3900), repetition = true}}};
