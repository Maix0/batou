...
{
	v->arr[4446] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
...
{
	v->arr[4458] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2371), repetition = true}}};
	v->arr[4460] = (t_pae){.entry = {.count = 2, .reusable = true}};
	v->arr[4461] = (t_pae){.action = {reduce = {.type = \
TSParseActionTypeReduce, symbol = aux_sym_for_statement_repeat1, .child_count = \
	2, dynamic_precedence = 0, .production_id = 0}}};
	v->arr[4461] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
...
TSParseActionTypeReduce, symbol = aux_sym_command_repeat2, .child_count = 2, \
	...
	v->arr[4485] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2422)}}};
	v->arr[4486] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[4487] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2389)}}};
	v->arr[4488] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4489] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2431)}}};
	v->arr[4490] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[4491] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2367)}}};
	v->arr[4492] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[4493] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2386)}}};
	v->arr[4494] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[4495] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (875)}}};
	init_pae339(v);
}
...
void	init_pae339(t_parse_action_entries *v)
{
	...
	v->arr[4497] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2365)}}};
	v->arr[4498] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[4499] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2438)}}};
	v->arr[4500] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4501] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3945)}}};
	v->arr[4502] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4503] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3944)}}};
	v->arr[4504] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[4505] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (5883)}}};
	v->arr[4506] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[4507] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2356)}}};
	v->arr[4508] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4509] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (5779)}}};
