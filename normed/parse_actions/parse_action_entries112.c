...
ACT_TY_REDUCE, .symbol = sym__c_postfix_expression, .child_count = 2, \
...
ACT_TY_REDUCE, .symbol = sym__c_unary_expression, .child_count = 2, \
...
ACT_TY_REDUCE, .symbol = sym__c_unary_expression, .child_count = 2, \
	...
	v->arr[7474] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2900)}}};
	v->arr[7475] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[7476] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3878)}}};
...
{
	v->arr[7478] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3878)}}};
	v->arr[7479] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[7480] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3208)}}};
	v->arr[7481] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[7482] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3219)}}};
	v->arr[7483] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[7484] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2145)}}};
	v->arr[7485] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[7486] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5028)}}};
	v->arr[7487] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[7488] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2636)}}};
...
ACT_TY_REDUCE, .symbol = sym__c_expression_not_assignment, \
	...
	v->arr[7494] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3206)}}};
...
ACT_TY_REDUCE, .symbol = sym__c_expression_not_assignment, \
	...
	v->arr[7506] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4097)}}};
	v->arr[7507] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[7508] = (t_pae){.action = {.reduce = {.type = \
ACT_TY_REDUCE, .symbol = sym__c_expression, .child_count = 1, \
	.dynamic_precedence = 0, .production_id = 0}}};
	v->arr[7509] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[7510] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5246)}}};
...
ACT_TY_REDUCE, .symbol = sym__c_expression, .child_count = 1, \
	...
	v->arr[7514] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4139)}}};
...
{
	v->arr[7516] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5032)}}};
	v->arr[7517] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[7518] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5594)}}};
	v->arr[7519] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[7520] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3121)}}};
...
ACT_TY_REDUCE, .symbol = aux_sym_command_repeat1, .child_count = 2, \
	.dynamic_precedence = 0, .production_id = 20}}};
	v->arr[7526] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
