...
{
	v->arr[8751] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (6456)}}};
...
{
	v->arr[8798] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (7631), repetition = true}}};
	v->arr[8800] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8801] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (6437)}}};
	v->arr[8802] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8803] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (6517)}}};
	v->arr[8804] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8805] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (6401)}}};
	v->arr[8806] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[8807] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (6302)}}};
	v->arr[8808] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8809] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (6302)}}};
	v->arr[8810] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8811] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (6312)}}};
	v->arr[8812] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8813] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (4870)}}};
	init_pae655(v);
}
