...
{
	v->arr[4576] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
...
ACT_TY_REDUCE, .symbol = aux_sym_concatenation_repeat1, .child_count = \
	...
	v->arr[4579] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3896), .repetition = true}}};
