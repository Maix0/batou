...
TSParseActionTypeReduce, .symbol = sym_number, child_count = 2, \
...
TSParseActionTypeReduce, symbol = sym_arithmetic_expansion, .child_count = 3, \
	dynamic_precedence = 0, .production_id = 0}}};
...
TSParseActionTypeReduce, .symbol = sym_expansion, child_count = 2, \
	.dynamic_precedence = 0, .production_id = 0}}};
	init_pae96(v);
}
...
TSParseActionTypeReduce, .symbol = sym_string, child_count = 3, \
	.dynamic_precedence = 0, .production_id = 0}}};
...
TSParseActionTypeReduce, symbol = sym_simple_expansion, .child_count = 2, \
...
TSParseActionTypeReduce, symbol = sym_translated_string, .child_count = 2, \
	dynamic_precedence = 0, .production_id = 0}}};
	init_pae97(v);
}
...
TSParseActionTypeReduce, .symbol = sym_string, child_count = 4, \
	.dynamic_precedence = 0, .production_id = 0}}};
...
TSParseActionTypeReduce, symbol = sym_simple_expansion, .child_count = 2, \
	...
	v->arr[1361] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (495)}}};
	init_pae98(v);
}
...
TSParseActionTypeReduce, symbol = aux_sym__literal_repeat1, .child_count = 2, \
	dynamic_precedence = 0, .production_id = 0}}};
	v->arr[1367] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
...
{
	v->arr[1372] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (7064)}}};
	v->arr[1374] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[1375] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3991)}}};
	v->arr[1376] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[1377] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3969)}}};
	v->arr[1378] = (t_pae){.entry = {.count = 2, .reusable = true}};
	v->arr[1379] = (t_pae){.action = {reduce = {.type = \
TSParseActionTypeReduce, symbol = aux_sym_concatenation_repeat1, .child_count = \
	2, dynamic_precedence = 0, .production_id = 0}}};
	v->arr[1379] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3921), repetition = true}}};
	v->arr[1381] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[1382] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (525)}}};
	v->arr[1383] = (t_pae){.entry = {.count = 2, .reusable = false}};
	v->arr[1384] = (t_pae){.action = {reduce = {.type = \
TSParseActionTypeReduce, symbol = aux_sym__literal_repeat1, .child_count = 2, \
	dynamic_precedence = 0, .production_id = 0}}};
	v->arr[1384] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
