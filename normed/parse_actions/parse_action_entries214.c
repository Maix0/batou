...
void	init_pae1070(t_parse_action_entries *v)
{
	...
	TSParseActionTypeShift, .state = (6495)}}};
...
TSParseActionTypeReduce, symbol = aux_sym_if_statement_repeat1, .child_count = \
	...
	TSParseActionTypeShift, .state = (418), repetition = true}}};
...
void	init_pae1073(t_parse_action_entries *v)
{
	...
	TSParseActionTypeShift, .state = (7272)}}};
...
TSParseActionTypeReduce, symbol = aux_sym_concatenation_repeat1, .child_count = \
	...
	TSParseActionTypeShift, .state = (3860), repetition = true}}};
...
TSParseActionTypeReduce, symbol = aux_sym_case_item_repeat1, .child_count = 2, \
	...
	TSParseActionTypeShift, .state = (6957)}}};
