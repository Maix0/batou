...
ACT_TY_REDUCE, .symbol = sym_case_statement, .child_count = 7, \
...
void	init_pae897(t_parse_action_entries *v)
{
	...
	ACT_TY_SHIFT, .state = (5044), .repetition = true}}};
	v->arr[12292] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[12293] = (t_pae){.action = {.reduce = {.type = \
ACT_TY_REDUCE, .symbol = sym_case_statement, .child_count = 6, \
