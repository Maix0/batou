...
TSParseActionTypeReduce, .symbol = sym__statements, child_count = 2, \
...
TSParseActionTypeReduce, .symbol = sym__statements, child_count = 2, \
	...
	v->arr[2724] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1078)}}};
	v->arr[2725] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[2726] = (t_pae){.action = {reduce = {.type = \
TSParseActionTypeReduce, .symbol = sym__statements, child_count = 3, \
	.dynamic_precedence = 0, .production_id = 0}}};
