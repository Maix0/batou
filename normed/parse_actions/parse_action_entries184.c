...
void	init_pae920(t_parse_action_entries *v)
{
	...
	TSParseActionTypeShift, .state = (3202)}}};
...
void	init_pae923(t_parse_action_entries *v)
{
	...
	TSParseActionTypeShift, .state = (3036)}}};
...
TSParseActionTypeReduce, symbol = sym_last_case_item, .child_count = 5, \
	...
	TSParseActionTypeShift, .state = (2947)}}};
