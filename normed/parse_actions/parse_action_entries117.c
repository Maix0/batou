...
{
	v->arr[7821] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3511)}}};
	v->arr[7822] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[7823] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (6379)}}};
	v->arr[7824] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[7825] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (6379)}}};
...
TSParseActionTypeReduce, symbol = sym__expansion_regex_replacement, \
	...
	v->arr[7829] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (6784)}}};
	v->arr[7830] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[7831] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (6372)}}};
...
{
	v->arr[7833] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3511), repetition = true}}};
	v->arr[7835] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[7836] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (6763)}}};
	v->arr[7837] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[7838] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (6763)}}};
...
TSParseActionTypeReduce, symbol = aux_sym_case_statement_repeat1, .child_count \
	...
	v->arr[7840] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (6328), repetition = true}}};
	v->arr[7842] = (t_pae){.entry = {.count = 2, .reusable = true}};
	v->arr[7843] = (t_pae){.action = {reduce = {.type = \
TSParseActionTypeReduce, symbol = aux_sym_case_statement_repeat1, .child_count \
	= 2, dynamic_precedence = 0, .production_id = 0}}};
	v->arr[7843] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
