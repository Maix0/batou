...
void	init_pae567(t_parse_action_entries *v)
{
	...
	v->arr[7554] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (6735)}}};
	v->arr[7555] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[7556] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2119)}}};
	v->arr[7557] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[7558] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4648)}}};
	v->arr[7559] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[7560] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1982)}}};
	v->arr[7561] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[7562] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5094)}}};
	v->arr[7563] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[7564] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5025)}}};
	v->arr[7565] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[7566] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5030)}}};
...
{
	v->arr[7568] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4130)}}};
	v->arr[7569] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[7570] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3450)}}};
	v->arr[7571] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[7572] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4131)}}};
	v->arr[7573] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[7574] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4132)}}};
	v->arr[7575] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[7576] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4134)}}};
	v->arr[7577] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[7578] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4142)}}};
	v->arr[7579] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[7580] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4143)}}};
	v->arr[7581] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[7582] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4145)}}};
	init_pae569(v);
}
...
void	init_pae569(t_parse_action_entries *v)
{
	...
	v->arr[7584] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4146)}}};
	v->arr[7585] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[7586] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4147)}}};
	v->arr[7587] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[7588] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4147)}}};
	v->arr[7589] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[7590] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4148)}}};
	v->arr[7591] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[7592] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4149)}}};
	v->arr[7593] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[7594] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4150)}}};
	v->arr[7595] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[7596] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4151)}}};
