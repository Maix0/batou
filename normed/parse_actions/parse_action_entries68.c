...
{
	v->arr[4511] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2438)}}};
	v->arr[4512] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[4513] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2560)}}};
	v->arr[4514] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[4515] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (6349)}}};
	v->arr[4516] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4517] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (4826)}}};
	v->arr[4518] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[4519] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (178)}}};
	v->arr[4520] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4521] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (183)}}};
	v->arr[4522] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4523] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (191)}}};
	v->arr[4524] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4525] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (115)}}};
	init_pae341(v);
}
...
void	init_pae341(t_parse_action_entries *v)
{
	...
	v->arr[4527] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2437)}}};
	v->arr[4528] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4529] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (7639)}}};
...
TSParseActionTypeReduce, symbol = aux_sym_unset_command_repeat1, .child_count = \
	...
	v->arr[4535] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
...
void	init_pae343(t_parse_action_entries *v)
{
	...
	v->arr[4551] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (865)}}};
	v->arr[4552] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[4553] = (t_pae){.action = {reduce = {.type = \
TSParseActionTypeReduce, symbol = sym_herestring_redirect, .child_count = 3, \
...
TSParseActionTypeReduce, symbol = sym_herestring_redirect, .child_count = 3, \
	...
	v->arr[4557] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2567)}}};
	v->arr[4558] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[4559] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (5779)}}};
	v->arr[4560] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[4561] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2536)}}};
	v->arr[4562] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4563] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2536)}}};
	init_pae344(v);
}
...
TSParseActionTypeReduce, .symbol = sym_command_name, child_count = 1, \
	...
	v->arr[4569] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (6890)}}};
	v->arr[4571] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4572] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3839)}}};
	v->arr[4573] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4574] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3843)}}};
