...
void	init_pae1027(t_parse_action_entries *v)
{
	...
	TSParseActionTypeShift, .state = (3655)}}};
	...
	TSParseActionTypeShift, .state = (778)}}};
...
TSParseActionTypeReduce, symbol = aux_sym_heredoc_body_repeat1, .child_count = \
	...
	TSParseActionTypeShift, .state = (6110), repetition = true}}};
