...
ACT_TY_REDUCE, .symbol = aux_sym_declaration_command_repeat1, \
	...
	v->arr[5183] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3891)}}};
	v->arr[5184] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5185] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3752)}}};
	v->arr[5186] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5187] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3756)}}};
