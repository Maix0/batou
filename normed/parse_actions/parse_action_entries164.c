...
ACT_TY_REDUCE, .symbol = aux_sym_variable_assignments_repeat1, \
	...
	ACT_TY_SHIFT, .state = (6662), .repetition = true}}};
...
ACT_TY_REDUCE, .symbol = aux_sym_concatenation_repeat1, .child_count = \
	...
	ACT_TY_SHIFT, .state = (3912), .repetition = true}}};
...
ACT_TY_REDUCE, .symbol = aux_sym_redirected_statement_repeat2, \
	...
	ACT_TY_SHIFT, .state = (3642), .repetition = true}}};
...
ACT_TY_REDUCE, .symbol = aux_sym_redirected_statement_repeat2, \
	...
	ACT_TY_SHIFT, .state = (631), .repetition = true}}};
...
ACT_TY_REDUCE, .symbol = sym_variable_assignments, .child_count = 2, \
