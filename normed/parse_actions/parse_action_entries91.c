...
{
	v->arr[6043] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
...
ACT_TY_REDUCE, .symbol = aux_sym__literal_repeat1, .child_count = 2, \
	...
	v->arr[6076] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
