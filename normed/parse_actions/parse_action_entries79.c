...
{
	v->arr[5237] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
...
ACT_TY_REDUCE, .symbol = aux_sym_concatenation_repeat1, .child_count = \
	...
	v->arr[5240] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3891), .repetition = true}}};
...
ACT_TY_REDUCE, .symbol = sym_command_name, .child_count = 1, \
	...
	v->arr[5243] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (7396)}}};
	v->arr[5245] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5246] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3891)}}};
	v->arr[5247] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5248] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3781)}}};
	v->arr[5249] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5250] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3785)}}};
	init_pae396(v);
}
...
{
	v->arr[5264] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5892)}}};
	v->arr[5265] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5266] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5240)}}};
	v->arr[5267] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5268] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5830)}}};
	v->arr[5269] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5270] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5378)}}};
	v->arr[5271] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5272] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5492)}}};
	v->arr[5273] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5274] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (6294)}}};
	v->arr[5275] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5276] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4718)}}};
	v->arr[5277] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5278] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (371)}}};
	init_pae398(v);
}
...
void	init_pae398(t_parse_action_entries *v)
{
	...
	v->arr[5280] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (370)}}};
	v->arr[5281] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5282] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (369)}}};
	v->arr[5283] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5284] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (264)}}};
	v->arr[5285] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5286] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5373)}}};
	v->arr[5287] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5288] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (7650)}}};
...
ACT_TY_REDUCE, .symbol = aux_sym__literal_repeat1, .child_count = 2, \
	.dynamic_precedence = 0, .production_id = 0}}};
	v->arr[5290] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
...
ACT_TY_REDUCE, .symbol = aux_sym__literal_repeat1, .child_count = 2, \
	.dynamic_precedence = 0, .production_id = 0}}};
	v->arr[5293] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1260), .repetition = true}}};
	v->arr[5295] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5296] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5352)}}};
	v->arr[5297] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5298] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5352)}}};
	v->arr[5299] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5300] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5359)}}};
	v->arr[5301] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5302] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5293)}}};
	v->arr[5303] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5304] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5206)}}};
	v->arr[5305] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5306] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5305)}}};
	init_pae400(v);
}
