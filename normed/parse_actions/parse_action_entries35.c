...
{
	v->arr[2352] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (324)}}};
	v->arr[2353] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2354] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (401)}}};
	v->arr[2355] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[2356] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1291)}}};
	v->arr[2357] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[2358] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (7657)}}};
	v->arr[2359] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2360] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1602)}}};
	v->arr[2361] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2362] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1665)}}};
	v->arr[2363] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2364] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (594)}}};
	v->arr[2365] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[2366] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (6560)}}};
	init_pae176(v);
}
...
void	init_pae176(t_parse_action_entries *v)
{
	...
	v->arr[2368] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1481)}}};
