...
{
	v->arr[6105] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
...
ACT_TY_REDUCE, .symbol = aux_sym_concatenation_repeat1, .child_count = \
	...
	v->arr[6108] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3774), .repetition = true}}};
	v->arr[6110] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6111] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4004)}}};
	v->arr[6112] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6113] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (7037)}}};
...
ACT_TY_REDUCE, .symbol = aux_sym_redirected_statement_repeat2, \
	...
	v->arr[6115] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5495)}}};
...
{
	v->arr[6118] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2597)}}};
	v->arr[6120] = (t_pae){.entry = {.count = 2, .reusable = false}};
	v->arr[6121] = (t_pae){.action = {.reduce = {.type = \
ACT_TY_REDUCE, .symbol = aux_sym_redirected_statement_repeat2, \
	.child_count = 1, .dynamic_precedence = 0, .production_id = 0}}};
	v->arr[6121] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2317)}}};
...
ACT_TY_REDUCE, .symbol = aux_sym__literal_repeat1, .child_count = 2, \
	...
	v->arr[6124] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2310), .repetition = true}}};
	v->arr[6126] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[6127] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2310)}}};
	v->arr[6128] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[6129] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2306)}}};
...
{
	v->arr[6131] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2306), .repetition = true}}};
	v->arr[6133] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6134] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3758)}}};
	v->arr[6135] = (t_pae){.entry = {.count = 2, .reusable = false}};
	v->arr[6136] = (t_pae){.action = {.reduce = {.type = \
ACT_TY_REDUCE, .symbol = aux_sym_redirected_statement_repeat2, \
	.child_count = 1, .dynamic_precedence = 0, .production_id = 0}}};
	v->arr[6136] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1550)}}};
	v->arr[6138] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[6139] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2563)}}};
	v->arr[6140] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6141] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2563)}}};
	v->arr[6142] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6143] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (452)}}};
	v->arr[6144] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6145] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3803)}}};
	init_pae463(v);
}
