...
{
	v->arr[8614] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (6338)}}};
	v->arr[8615] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8616] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (6364)}}};
	v->arr[8617] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8618] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2106)}}};
	v->arr[8619] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8620] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1748)}}};
	v->arr[8621] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[8622] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5158)}}};
	v->arr[8623] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[8624] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5762)}}};
	v->arr[8625] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[8626] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5154)}}};
	v->arr[8627] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8628] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5154)}}};
	init_pae641(v);
}
...
void	init_pae641(t_parse_action_entries *v)
{
	...
	v->arr[8630] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2071)}}};
	v->arr[8631] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8632] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1961)}}};
	v->arr[8633] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8634] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2015)}}};
	v->arr[8635] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8636] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (6368)}}};
	v->arr[8637] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8638] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4840)}}};
	v->arr[8639] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8640] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (6433)}}};
	v->arr[8641] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[8642] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4804)}}};
...
{
	v->arr[8644] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (6461)}}};
