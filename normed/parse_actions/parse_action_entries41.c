...
{
	v->arr[2730] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
...
void	init_pae209(t_parse_action_entries *v)
{
	...
	v->arr[2781] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1326)}}};
	v->arr[2782] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2783] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3786)}}};
	v->arr[2784] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2785] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3789)}}};
	v->arr[2786] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2787] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (6078)}}};
	v->arr[2788] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2789] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1369)}}};
	v->arr[2790] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2791] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (5791)}}};
	v->arr[2792] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2793] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1496)}}};
