...
ACT_TY_REDUCE, .symbol = sym__simple_heredoc_body, .child_count = 2, \
...
ACT_TY_REDUCE, .symbol = sym_case_statement, .child_count = 4, \
...
ACT_TY_REDUCE, .symbol = sym_heredoc_redirect, .child_count = 7, \
...
ACT_TY_REDUCE, .symbol = sym_for_statement, .child_count = 4, \
