...
{
	v->arr[4318] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
...
{
	v->arr[4357] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4901)}}};
	v->arr[4358] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4359] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4906)}}};
	v->arr[4360] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[4361] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4640)}}};
	v->arr[4362] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[4363] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4578)}}};
	v->arr[4364] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4365] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4626)}}};
	v->arr[4366] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[4367] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4627)}}};
	v->arr[4368] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4369] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4633)}}};
...
ACT_TY_REDUCE, .symbol = sym_herestring_redirect, .child_count = 2, \
	...
	v->arr[4375] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3896)}}};
	v->arr[4376] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4377] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3896)}}};
	v->arr[4378] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[4379] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (625)}}};
	v->arr[4380] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[4381] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (436)}}};
	v->arr[4382] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[4383] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (7514)}}};
	v->arr[4384] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4385] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (625)}}};
	init_pae330(v);
}
