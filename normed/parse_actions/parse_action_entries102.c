...
void	init_pae510(t_parse_action_entries *v)
{
	...
	v->arr[6760] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3683)}}};
	v->arr[6761] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6762] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (4128)}}};
...
TSParseActionTypeReduce, symbol = aux_sym__literal_repeat1, .child_count = 2, \
	...
	v->arr[6764] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2725), repetition = true}}};
	v->arr[6766] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6767] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (4156)}}};
	v->arr[6768] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6769] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3937)}}};
	v->arr[6770] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6771] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2061)}}};
...
TSParseActionTypeReduce, symbol = aux_sym__literal_repeat1, .child_count = 2, \
	dynamic_precedence = 0, .production_id = 0}}};
	v->arr[6773] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2798), repetition = true}}};
	v->arr[6775] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6776] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2805)}}};
	v->arr[6777] = (t_pae){.entry = {.count = 2, .reusable = false}};
	v->arr[6778] = (t_pae){.action = {reduce = {.type = \
TSParseActionTypeReduce, symbol = aux_sym__literal_repeat1, .child_count = 2, \
	dynamic_precedence = 0, .production_id = 0}}};
	v->arr[6778] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2819), repetition = true}}};
	v->arr[6780] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6781] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3882)}}};
	v->arr[6782] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6783] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3871)}}};
	v->arr[6784] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6785] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3852)}}};
	init_pae512(v);
}
...
TSParseActionTypeReduce, symbol = aux_sym_concatenation_repeat1, .child_count = \
	...
	v->arr[6787] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3882), repetition = true}}};
	v->arr[6789] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6790] = (t_pae){.action = {reduce = {.type = \
TSParseActionTypeReduce, symbol = sym_unary_expression, .child_count = 2, \
...
TSParseActionTypeReduce, symbol = sym_unary_expression, .child_count = 2, \
	...
	v->arr[6794] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2627)}}};
	v->arr[6795] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6796] = (t_pae){.action = {reduce = {.type = \
TSParseActionTypeReduce, symbol = sym_postfix_expression, .child_count = 2, \
...
TSParseActionTypeReduce, symbol = sym_parenthesized_expression, .child_count = \
...
TSParseActionTypeReduce, symbol = sym_parenthesized_expression, .child_count = \
	...
	v->arr[6804] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2796)}}};
	v->arr[6805] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6806] = (t_pae){.action = {reduce = {.type = \
TSParseActionTypeReduce, symbol = sym_binary_expression, .child_count = 3, \
...
void	init_pae514(t_parse_action_entries *v)
{
	...
	v->arr[6810] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2798)}}};
	v->arr[6811] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6812] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2935)}}};
	v->arr[6813] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6814] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2927)}}};
	v->arr[6815] = (t_pae){.entry = {.count = 2, .reusable = true}};
	v->arr[6816] = (t_pae){.action = {reduce = {.type = \
TSParseActionTypeReduce, symbol = aux_sym__literal_repeat1, .child_count = 2, \
	dynamic_precedence = 0, .production_id = 0}}};
	v->arr[6816] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
