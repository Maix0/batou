...
ACT_TY_REDUCE, .symbol = aux_sym__literal_repeat1, .child_count = 2, \
	...
	v->arr[5534] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1338), .repetition = true}}};
	v->arr[5536] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5537] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3951)}}};
	v->arr[5538] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5539] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3951)}}};
	init_pae417(v);
}
...
void	init_pae417(t_parse_action_entries *v)
{
	...
	v->arr[5541] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3899)}}};
	v->arr[5542] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5543] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3899)}}};
	v->arr[5544] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5545] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4214)}}};
	v->arr[5546] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5547] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5844)}}};
	v->arr[5548] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5549] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4749)}}};
	v->arr[5550] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5551] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (396)}}};
	v->arr[5552] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5553] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (395)}}};
...
{
	v->arr[5555] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (394)}}};
	v->arr[5556] = (t_pae){.entry = {.count = 2, .reusable = false}};
	v->arr[5557] = (t_pae){.action = {.reduce = {.type = \
ACT_TY_REDUCE, .symbol = aux_sym__literal_repeat1, .child_count = 2, \
	.dynamic_precedence = 0, .production_id = 0}}};
	v->arr[5557] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
