...
{
	v->arr[2986] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
...
void	init_pae228(t_parse_action_entries *v)
{
	...
	v->arr[3025] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3893)}}};
	v->arr[3026] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3027] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (6035)}}};
	v->arr[3028] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3029] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4233)}}};
	v->arr[3030] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3031] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5775)}}};
	v->arr[3032] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3033] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4575)}}};
	v->arr[3034] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3035] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (6248)}}};
	v->arr[3036] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3037] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4658)}}};
...
{
	v->arr[3039] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (286)}}};
	v->arr[3040] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3041] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (106)}}};
	v->arr[3042] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3043] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (279)}}};
	v->arr[3044] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3045] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (345)}}};
	v->arr[3046] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[3047] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4299)}}};
	v->arr[3048] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[3049] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (7668)}}};
	v->arr[3050] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3051] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (760)}}};
	v->arr[3052] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3053] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (711)}}};
	init_pae230(v);
}
