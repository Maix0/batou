...
void	init_pae230(t_parse_action_entries *v)
{
	...
	v->arr[3055] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (762)}}};
	v->arr[3056] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3057] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (763)}}};
	v->arr[3058] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[3059] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (763)}}};
	v->arr[3060] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[3061] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (117)}}};
	v->arr[3062] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[3063] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2836)}}};
	v->arr[3064] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[3065] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2589)}}};
