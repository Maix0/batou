...
void	init_pae827(t_parse_action_entries *v)
{
	...
	TSParseActionTypeShift, .state = (3953)}}};
...
TSParseActionTypeReduce, symbol = aux_sym_concatenation_repeat1, .child_count = \
	...
	TSParseActionTypeShift, .state = (3941), repetition = true}}};
...
TSParseActionTypeReduce, symbol = aux_sym_concatenation_repeat1, .child_count = \
	...
	TSParseActionTypeShift, .state = (4017)}}};
	init_pae828(v);
}
...
void	init_pae828(t_parse_action_entries *v)
{
	...
	TSParseActionTypeShift, .state = (3900)}}};
...
TSParseActionTypeReduce, symbol = aux_sym_concatenation_repeat1, .child_count = \
	...
	TSParseActionTypeShift, .state = (3778), repetition = true}}};
...
TSParseActionTypeReduce, symbol = aux_sym_concatenation_repeat1, .child_count = \
	...
	TSParseActionTypeShift, .state = (4165)}}};
