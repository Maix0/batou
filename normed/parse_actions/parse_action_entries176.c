...
ACT_TY_REDUCE, .symbol = sym_case_statement, .child_count = 8, \
...
ACT_TY_REDUCE, .symbol = sym_case_statement, .child_count = 5, \
	.dynamic_precedence = 0, .production_id = 46}}};
...
ACT_TY_REDUCE, .symbol = sym__heredoc_body, .child_count = 2, \
	.dynamic_precedence = 0, .production_id = 0}}};
