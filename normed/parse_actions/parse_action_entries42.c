...
{
	v->arr[2795] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (6251)}}};
	v->arr[2796] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2797] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (4676)}}};
	v->arr[2798] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2799] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (308)}}};
	v->arr[2800] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2801] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (307)}}};
	v->arr[2802] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2803] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (306)}}};
	v->arr[2804] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2805] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (377)}}};
	v->arr[2806] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2807] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (633)}}};
	v->arr[2808] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[2809] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1325)}}};
	init_pae211(v);
}
...
void	init_pae211(t_parse_action_entries *v)
{
	...
	v->arr[2811] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (7663)}}};
