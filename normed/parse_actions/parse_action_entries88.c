...
ACT_TY_REDUCE, .symbol = aux_sym__literal_repeat1, .child_count = 2, \
	...
	v->arr[5842] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1835), .repetition = true}}};
	v->arr[5844] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5845] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3766)}}};
	v->arr[5846] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5847] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3766)}}};
	v->arr[5848] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5849] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5842)}}};
	v->arr[5850] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5851] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4744)}}};
	v->arr[5852] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5853] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (392)}}};
...
{
	v->arr[5855] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (391)}}};
	v->arr[5856] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5857] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (390)}}};
...
void	init_pae442(t_parse_action_entries *v)
{
	...
	v->arr[5869] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3862)}}};
	v->arr[5870] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5871] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5992)}}};
	v->arr[5872] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5873] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5518)}}};
	v->arr[5874] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5875] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5846)}}};
	v->arr[5876] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5877] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5625)}}};
	v->arr[5878] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5879] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (6362)}}};
	v->arr[5880] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5881] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4752)}}};
...
{
	v->arr[5883] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (400)}}};
	v->arr[5884] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5885] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (399)}}};
	v->arr[5886] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5887] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (398)}}};
	v->arr[5888] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5889] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (172)}}};
	v->arr[5890] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5891] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5562)}}};
	v->arr[5892] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5893] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (7645)}}};
	v->arr[5894] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5895] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1885)}}};
...
{
	v->arr[5897] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3948), .repetition = true}}};
	v->arr[5899] = (t_pae){.entry = {.count = 2, .reusable = true}};
	v->arr[5900] = (t_pae){.action = {.reduce = {.type = \
ACT_TY_REDUCE, .symbol = aux_sym_concatenation_repeat1, .child_count = \
	2, .dynamic_precedence = 0, .production_id = 0}}};
	v->arr[5900] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3948), .repetition = true}}};
	v->arr[5902] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5903] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4011)}}};
	v->arr[5904] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5905] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4010)}}};
	v->arr[5906] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5907] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4009)}}};
	v->arr[5908] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5909] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4007)}}};
	v->arr[5910] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5911] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5553)}}};
	init_pae445(v);
}
