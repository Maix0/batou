...
ACT_TY_REDUCE, .symbol = aux_sym_variable_assignments_repeat1, \
	...
	ACT_TY_SHIFT, .state = (6604), .repetition = true}}};
	v->arr[12034] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[12035] = (t_pae){.action = {.reduce = {.type = \
ACT_TY_REDUCE, .symbol = sym_compound_statement, .child_count = 2, \
...
ACT_TY_REDUCE, .symbol = sym_pipeline, .child_count = 2, \
	.dynamic_precedence = 0, .production_id = 0}}};
