...
TSParseActionTypeReduce, .symbol = sym_if_statement, child_count = 4, \
...
TSParseActionTypeReduce, .symbol = sym_if_statement, child_count = 4, \
	...
	TSParseActionTypeShift, .state = (3531)}}};
...
TSParseActionTypeReduce, symbol = sym_while_statement, .child_count = 3, \
...
TSParseActionTypeReduce, .symbol = sym__for_body, child_count = 5, \
	...
	TSParseActionTypeShift, .state = (5142)}}};
	init_pae860(v);
}
