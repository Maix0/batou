...
{
	v->arr[4196] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
...
void	init_pae319(t_parse_action_entries *v)
{
	...
	v->arr[4246] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4795)}}};
...
ACT_TY_REDUCE, .symbol = aux_sym_command_repeat1, .child_count = 1, \
	...
	v->arr[4250] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (622)}}};
	v->arr[4251] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[4252] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (450)}}};
...
ACT_TY_REDUCE, .symbol = sym__statement_not_pipeline, .child_count = \
	...
	v->arr[4256] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (7487)}}};
