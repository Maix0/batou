...
TSParseActionTypeReduce, symbol = sym_c_style_for_statement, .child_count = 5, \
...
TSParseActionTypeReduce, symbol = sym_heredoc_redirect, .child_count = 6, \
	...
	TSParseActionTypeShift, .state = (6113)}}};
...
TSParseActionTypeReduce, symbol = sym_c_style_for_statement, .child_count = 6, \
...
TSParseActionTypeReduce, .symbol = sym_for_statement, child_count = 6, \
...
TSParseActionTypeReduce, symbol = sym_function_definition, .child_count = 6, \
