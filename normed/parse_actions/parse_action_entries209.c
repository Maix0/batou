...
void	init_pae1045(t_parse_action_entries *v)
{
	...
	ACT_TY_SHIFT, .state = (6361), .repetition = true}}};
...
ACT_TY_REDUCE, .symbol = aux_sym_concatenation_repeat1, .child_count = \
	...
	ACT_TY_SHIFT, .state = (3776), .repetition = true}}};
