...
ACT_TY_REDUCE, .symbol = aux_sym__concatenation_in_expansion_repeat1, \
...
ACT_TY_REDUCE, .symbol = aux_sym__concatenation_in_expansion_repeat1, \
	...
	ACT_TY_SHIFT, .state = (5425), .repetition = true}}};
...
ACT_TY_REDUCE, .symbol = aux_sym__for_body_repeat1, .child_count = 2, \
	...
	ACT_TY_SHIFT, .state = (4999), .repetition = true}}};
...
ACT_TY_REDUCE, .symbol = aux_sym__expansion_body_repeat1, .child_count \
...
ACT_TY_REDUCE, .symbol = aux_sym__expansion_body_repeat1, .child_count \
	...
	ACT_TY_SHIFT, .state = (6489), .repetition = true}}};
	init_pae1078(v);
}
...
ACT_TY_REDUCE, .symbol = sym__concatenation_in_expansion, .child_count \
