...
void	init_pae20(t_parse_action_entries *v)
{
	...
	v->arr[297] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (418)}}};
	v->arr[298] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[299] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (226)}}};
	v->arr[300] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[301] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (7392)}}};
	v->arr[302] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[303] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (623)}}};
	v->arr[304] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[305] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (602)}}};
	v->arr[306] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[307] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (718)}}};
	v->arr[308] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[309] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (759)}}};
...
{
	v->arr[311] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4030)}}};
	v->arr[312] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[313] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4154)}}};
	v->arr[314] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[315] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4155)}}};
	v->arr[316] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[317] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5968)}}};
	v->arr[318] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[319] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1105)}}};
	v->arr[320] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[321] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5849)}}};
	v->arr[322] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[323] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1078)}}};
	v->arr[324] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[325] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1085)}}};
	init_pae22(v);
}
...
void	init_pae22(t_parse_action_entries *v)
{
	...
	v->arr[327] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (6359)}}};
	v->arr[328] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[329] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4814)}}};
	v->arr[330] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[331] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (148)}}};
	v->arr[332] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[333] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (150)}}};
	v->arr[334] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[335] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (151)}}};
	v->arr[336] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[337] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (152)}}};
	v->arr[338] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[339] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (6148)}}};
...
{
	v->arr[341] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (6616)}}};
	v->arr[342] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[343] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1077)}}};
	v->arr[344] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[345] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (7608)}}};
	v->arr[346] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[347] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5567)}}};
	v->arr[348] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[349] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4950)}}};
	v->arr[350] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[351] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2521)}}};
	v->arr[352] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[353] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3699)}}};
	v->arr[354] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[355] = (t_pae){.action = {.reduce = {.type = ACT_TY_REDUCE, \
...
void	init_pae24(t_parse_action_entries *v)
{
	...
	v->arr[357] = (t_pae){.action = {.reduce = {.type = ACT_TY_REDUCE, \
...
.symbol = sym__expression, .child_count = 1, .dynamic_precedence = 0, \
	...
	v->arr[360] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2261)}}};
	v->arr[361] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[362] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (2001)}}};
	v->arr[363] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[364] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4215)}}};
	v->arr[365] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[366] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3921)}}};
	v->arr[367] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[368] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5935)}}};
	init_pae25(v);
}
