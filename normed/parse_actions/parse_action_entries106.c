...
void	init_pae530(t_parse_action_entries *v)
{
	...
	v->arr[7040] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2030)}}};
	v->arr[7041] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[7042] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2031)}}};
	v->arr[7043] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[7044] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1685)}}};
	v->arr[7045] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[7046] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2034)}}};
	v->arr[7047] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[7048] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2034)}}};
	v->arr[7049] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[7050] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2007)}}};
...
TSParseActionTypeReduce, symbol = sym__arithmetic_expression, .child_count = 1, \
	...
	v->arr[7056] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1490)}}};
...
TSParseActionTypeReduce, symbol = aux_sym__literal_repeat1, .child_count = 2, \
	...
	v->arr[7058] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3149), repetition = true}}};
	v->arr[7060] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[7061] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (7193)}}};
...
void	init_pae532(t_parse_action_entries *v)
{
	...
	v->arr[7067] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (514)}}};
	v->arr[7068] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[7069] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (6834)}}};
	v->arr[7070] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[7071] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (6231)}}};
	v->arr[7072] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[7073] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2022)}}};
	v->arr[7074] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[7075] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2014)}}};
	v->arr[7076] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[7077] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2021)}}};
	v->arr[7078] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[7079] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1778)}}};
...
{
	v->arr[7081] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2266)}}};
	v->arr[7082] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[7083] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (6990)}}};
	v->arr[7084] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[7085] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (7181)}}};
	v->arr[7086] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[7087] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1027)}}};
...
TSParseActionTypeReduce, symbol = sym__c_expression_not_assignment, \
	...
	v->arr[7091] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (4934)}}};
...
TSParseActionTypeReduce, symbol = sym__arithmetic_unary_expression, \
...
TSParseActionTypeReduce, symbol = sym__arithmetic_unary_expression, \
	...
	v->arr[7099] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (4499)}}};
	v->arr[7100] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[7101] = (t_pae){.action = {reduce = {.type = \
TSParseActionTypeReduce, symbol = sym__arithmetic_ternary_expression, \
