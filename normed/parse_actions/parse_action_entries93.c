...
TSParseActionTypeReduce, symbol = aux_sym_redirected_statement_repeat2, \
	...
	v->arr[6170] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1591)}}};
	v->arr[6172] = (t_pae){.entry = {.count = 2, .reusable = false}};
	v->arr[6173] = (t_pae){.action = {reduce = {.type = \
TSParseActionTypeReduce, symbol = aux_sym_redirected_statement_repeat2, \
	.child_count = 1, dynamic_precedence = 0, .production_id = 0}}};
	v->arr[6173] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1353)}}};
	v->arr[6175] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[6176] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2461)}}};
	v->arr[6177] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6178] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (2461)}}};
	v->arr[6179] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6180] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (453)}}};
...
TSParseActionTypeReduce, symbol = aux_sym_redirected_statement_repeat2, \
	.child_count = 1, dynamic_precedence = 0, .production_id = 0}}};
	v->arr[6194] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1365)}}};
	v->arr[6196] = (t_pae){.entry = {.count = 2, .reusable = false}};
	v->arr[6197] = (t_pae){.action = {reduce = {.type = \
TSParseActionTypeReduce, symbol = aux_sym_redirected_statement_repeat2, \
	.child_count = 1, dynamic_precedence = 0, .production_id = 0}}};
	v->arr[6197] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (4553)}}};
	v->arr[6199] = (t_pae){.entry = {.count = 2, .reusable = false}};
	v->arr[6200] = (t_pae){.action = {reduce = {.type = \
TSParseActionTypeReduce, symbol = aux_sym_redirected_statement_repeat2, \
	.child_count = 1, dynamic_precedence = 0, .production_id = 0}}};
	v->arr[6200] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1579)}}};
...
{
	v->arr[6203] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (900)}}};
	v->arr[6205] = (t_pae){.entry = {.count = 2, .reusable = false}};
	v->arr[6206] = (t_pae){.action = {reduce = {.type = \
TSParseActionTypeReduce, symbol = aux_sym_redirected_statement_repeat2, \
	.child_count = 1, dynamic_precedence = 0, .production_id = 0}}};
	v->arr[6206] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1438)}}};
	v->arr[6208] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[6209] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3494)}}};
	v->arr[6210] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[6211] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (5716)}}};
	v->arr[6212] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[6213] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3498)}}};
	v->arr[6214] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[6215] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3498)}}};
...
TSParseActionTypeReduce, symbol = aux_sym_concatenation_repeat1, .child_count = \
	...
	v->arr[6226] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
