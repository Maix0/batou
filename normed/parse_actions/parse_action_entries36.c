...
{
	v->arr[2412] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (7657), .repetition = true}}};
	v->arr[2414] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2415] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (612)}}};
	v->arr[2416] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2417] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1794)}}};
	v->arr[2418] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2419] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3697)}}};
	v->arr[2420] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2421] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4138)}}};
	v->arr[2422] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2423] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1823)}}};
	v->arr[2424] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[2425] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1795)}}};
	v->arr[2426] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2427] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1247)}}};
	init_pae181(v);
}
...
void	init_pae181(t_parse_action_entries *v)
{
	...
	v->arr[2429] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5825)}}};
	v->arr[2430] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2431] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1246)}}};
	v->arr[2432] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[2433] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1246)}}};
