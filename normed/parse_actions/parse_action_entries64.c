...
void	init_pae320(t_parse_action_entries *v)
{
	...
	v->arr[4260] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (622)}}};
...
TSParseActionTypeReduce, symbol = aux_sym_command_repeat1, .child_count = 1, \
	dynamic_precedence = 0, .production_id = 0}}};
	v->arr[4264] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (6662)}}};
	v->arr[4266] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[4267] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3881)}}};
	v->arr[4268] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4269] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3939)}}};
	v->arr[4270] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[4271] = (t_pae){.action = {reduce = {.type = \
TSParseActionTypeReduce, .symbol = sym_list, child_count = 3, \
	.dynamic_precedence = 0, .production_id = 0}}};
	init_pae321(v);
}
...
TSParseActionTypeReduce, .symbol = sym_command_name, child_count = 1, \
	.dynamic_precedence = 0, .production_id = 0}}};
	v->arr[4284] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (6956)}}};
	v->arr[4286] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4287] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3881)}}};
	v->arr[4288] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[4289] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (3924)}}};
	v->arr[4290] = (t_pae){.entry = {.count = 2, .reusable = false}};
	v->arr[4291] = (t_pae){.action = {reduce = {.type = \
TSParseActionTypeReduce, symbol = aux_sym_for_statement_repeat1, .child_count = \
	2, dynamic_precedence = 0, .production_id = 0}}};
	v->arr[4291] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
