...
{
	v->arr[1654] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
...
void	init_pae123(t_parse_action_entries *v)
{
	...
	v->arr[1693] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1174)}}};
	v->arr[1694] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[1695] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1203)}}};
...
TSParseActionTypeReduce, symbol = aux_sym_declaration_command_repeat1, \
	...
	v->arr[1697] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1067), repetition = true}}};
	v->arr[1699] = (t_pae){.entry = {.count = 2, .reusable = false}};
	v->arr[1700] = (t_pae){.action = {reduce = {.type = \
TSParseActionTypeReduce, symbol = aux_sym_declaration_command_repeat1, \
	.child_count = 2, dynamic_precedence = 0, .production_id = 0}}};
	v->arr[1700] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
