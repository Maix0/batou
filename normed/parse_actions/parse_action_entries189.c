...
ACT_TY_REDUCE, .symbol = aux_sym__literal_repeat1, .child_count = 2, \
	...
	ACT_TY_SHIFT, .state = (5512), .repetition = true}}};
...
ACT_TY_REDUCE, .symbol = aux_sym__literal_repeat1, .child_count = 2, \
	...
	ACT_TY_SHIFT, .state = (5607), .repetition = true}}};
