...
{
	v->arr[2475] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
...
void	init_pae186(t_parse_action_entries *v)
{
	...
	v->arr[2489] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1309)}}};
	v->arr[2490] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2491] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1310)}}};
	v->arr[2492] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[2493] = (t_pae){.action = {.shift = {.type = TSParseActionTypeShift, \
	.state = (1310)}}};
	v->arr[2494] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[2495] = (t_pae){.action = {reduce = {.type = \
TSParseActionTypeReduce, .symbol = sym_file_redirect, child_count = 1, \
