...
ACT_TY_REDUCE, .symbol = aux_sym_pipeline_repeat1, .child_count = 2, \
	...
	ACT_TY_SHIFT, .state = (448), .repetition = true}}};
...
ACT_TY_REDUCE, .symbol = sym_last_case_item, .child_count = 6, \
