...
void	init_pae1087(t_parse_action_entries *v)
{
	...
	TSParseActionTypeShift, .state = (4108), repetition = true}}};
	...
	TSParseActionTypeShift, .state = (38)}}};
	init_pae1088(v);
}
...
void	init_pae1088(t_parse_action_entries *v)
{
	...
	TSParseActionTypeShift, .state = (39)}}};
