...
{
	v->arr[5578] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
...
{
	v->arr[5602] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (7644), .repetition = true}}};
	v->arr[5604] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5605] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3093)}}};
	v->arr[5606] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5607] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3875)}}};
	v->arr[5608] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5609] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3874)}}};
	v->arr[5610] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5611] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5952)}}};
	v->arr[5612] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5613] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3110)}}};
	v->arr[5614] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5615] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (5850)}}};
	v->arr[5616] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5617] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3184)}}};
	init_pae423(v);
}
...
void	init_pae423(t_parse_action_entries *v)
{
	...
	v->arr[5619] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (6315)}}};
	v->arr[5620] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5621] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4756)}}};
	v->arr[5622] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5623] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (404)}}};
	v->arr[5624] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5625] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (403)}}};
	v->arr[5626] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5627] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (402)}}};
	v->arr[5628] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5629] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (162)}}};
	v->arr[5630] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5631] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3092)}}};
...
{
	v->arr[5633] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (7644)}}};
	v->arr[5634] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5635] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4065)}}};
	v->arr[5636] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5637] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (4065)}}};
	v->arr[5638] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5639] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3853)}}};
	v->arr[5640] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5641] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3853)}}};
	v->arr[5642] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5643] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (1656)}}};
	v->arr[5644] = (t_pae){.entry = {.count = 1, .reusable = false}};
	v->arr[5645] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3946)}}};
	v->arr[5646] = (t_pae){.entry = {.count = 1, .reusable = true}};
	v->arr[5647] = (t_pae){.action = {.shift = {.type = ACT_TY_SHIFT, \
	.state = (3946)}}};
	init_pae425(v);
}
