...
void	init_ts_symbol_metadata(TSSymbolMetadata v)
{
	...
	v->arr[aux_sym__simple_variable_name_token1] = (t_sm){.visible = 1, .named = 1};
	v->arr[aux_sym__multiline_variable_name_token1] = (t_sm){.visible = 1, .named = 1};
	...
	v->arr[sym__external_expansion_sym_hash] = (t_sm){.visible = 1, .named = 0};
	v->arr[sym__external_expansion_sym_bang] = (t_sm){.visible = 1, .named = 0};
	v->arr[sym__external_expansion_sym_equal] = (t_sm){.visible = 1, .named = 0};
	...
	v->arr[sym__c_expression_not_assignment] = (t_sm){.visible = 0, .named = 1};
	...
	v->arr[sym__test_command_binary_expression] = (t_sm){.visible = 1, .named = 1};
	...
	v->arr[sym__arithmetic_binary_expression] = (t_sm){.visible = 1, .named = 1};
	v->arr[sym__arithmetic_ternary_expression] = (t_sm){.visible = 1, .named = 1};
	v->arr[sym__arithmetic_unary_expression] = (t_sm){.visible = 1, .named = 1};
	v->arr[sym__arithmetic_postfix_expression] = (t_sm){.visible = 1, .named = 1};
	v->arr[sym__arithmetic_parenthesized_expression] = (t_sm){.visible = 1, .named = 1};
	...
	v->arr[sym__expansion_regex_replacement] = (t_sm){.visible = 0, .named = 1};
	v->arr[sym__expansion_regex_removal] = (t_sm){.visible = 0, .named = 1};
	v->arr[sym__expansion_max_length] = (t_sm){.visible = 0, .named = 1};
	v->arr[sym__expansion_max_length_expression] = (t_sm){.visible = 0, .named = 1};
	v->arr[sym__expansion_max_length_binary_expression] = (t_sm){.visible = 1, .named = 1};
	...
	v->arr[aux_sym_redirected_statement_repeat1] = (t_sm){.visible = 0, .named = 0};
	v->arr[aux_sym_redirected_statement_repeat2] = (t_sm){.visible = 0, .named = 0};
	...
	v->arr[aux_sym_declaration_command_repeat1] = (t_sm){.visible = 0, .named = 0};
	...
	v->arr[aux_sym_variable_assignments_repeat1] = (t_sm){.visible = 0, .named = 0};
	v->arr[aux_sym_heredoc_body_repeat1] = (t_sm){.visible = 0, .named = 0};
	v->arr[aux_sym__literal_repeat1] = (t_sm){.visible = 0, .named = 0};
	v->arr[aux_sym_arithmetic_expansion_repeat1] = (t_sm){.visible = 0, .named = 0};
	...
	v->arr[aux_sym__expansion_regex_repeat1] = (t_sm){.visible = 0, .named = 0};
	v->arr[aux_sym__concatenation_in_expansion_repeat1] = (t_sm){.visible = 0, .named = 0};
}
