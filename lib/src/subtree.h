...
#undef SUBTREE_SIZE
	...
	static inline Subtree null_subtree(void)
	{
		return (((Subtree){.ptr = NULL}));
	}
	...
	void ts_subtree_array_remove_trailing_extras(SubtreeArray *,
												 SubtreeArray *);
	...
	Subtree		   ts_subtree_new_leaf(SubtreePool *, TSSymbol, Length, Length,
									   uint32_t, TSStateId, bool, bool, bool,
									   const TSLanguage *);
	Subtree		   ts_subtree_new_error(SubtreePool *, int32_t, Length, Length,
										uint32_t, TSStateId, const TSLanguage *);
	...
	Subtree ts_subtree_new_missing_leaf(SubtreePool *, TSSymbol, Length,
										uint32_t, const TSLanguage *);
...
#define ts_subtree_children(self)                                              \
	...
	static inline bool ts_subtree_has_external_scanner_state_change(
		Subtree self)
	{
