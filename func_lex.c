...
start:
  ...
  case 6: {
    static const uint16_t map[] = {
        ...
        '-',  769, '/',  644, '0',  803, ';', 555, '<', 607, '=', 560,
        '>',  616, '?',  761, '\\', 307, '^', 596, '`', 856, '|', 592,
        '~',  772, '[',  786, ']',  786, '{', 786, '}', 786,
    };
    for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
      if (map[i] == lookahead) {
  ...
  case 83: {
    static const uint16_t map[] = {
        '\n', 690, '!', 506, '#', 862, '%', 650, '&', 600, '*', 639, '+', 631,
        ',',  556, '-', 635, '/', 645, ';', 553, '<', 615, '=', 561, '>', 620,
    };
    for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
      if (map[i] == lookahead) {
        state = map[i + 1];
  ...
  case 146: {
    static const uint16_t map[] = {
        '\n', 691, '!', 951, '"', 788, '#', 862, '$', 781, '%', 649, '&',  601,
        '\'', 491, '(', 654, ')', 655, '*', 638, '+', 630, '-', 633, '/',  644,
        '0',  803, ';', 555, '<', 607, '=', 560, '>', 616, '?', 761, '\\', 316,
        '^',  596, '`', 856, '|', 592, '[', 786, ']', 786, '{', 786, '}',  786,
    };
    for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
      if (map[i] == lookahead) {
        state = map[i + 1];
  ...
  case 236: {
    static const uint16_t map[] = {
        '\n', 694, '!', 951, '"', 788, '#', 862, '$', 781, '%', 649, '&',  601,
        '\'', 491, '(', 654, ')', 655, '*', 638, '+', 630, '-', 633, '/',  644,
        '0',  803, ';', 555, '<', 607, '=', 560, '>', 616, '?', 761, '\\', 317,
        '^',  596, '`', 855, '|', 592, '[', 786, ']', 786, '{', 786, '}',  786,
    };
    for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
      if (map[i] == lookahead) {
        state = map[i + 1];
  ...
  case 239: {
    static const uint16_t map[] = {
        '\n', 697, '"', 788, '#', 862, '$', 781, '&', 602, '\'', 491, '(',  654,
        '-',  950, '0', 803, ';', 554, '<', 609, '=', 952, '>',  617, '\\', 321,
        '`',  855, 'e', 956, '|', 593, '[', 786, ']', 786, '{',  786, '}',  786,
    };
    for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
      if (map[i] == lookahead) {
        state = map[i + 1];
  ...
  case 242: {
    static const uint16_t map[] = {
        '\n', 700, '"', 788, '#', 862, '$', 781, '&', 602, '\'', 491, '(',  654,
        '-',  950, '0', 803, ';', 554, '<', 609, '=', 952, '>',  617, '\\', 322,
        '`',  855, '|', 593, '[', 786, ']', 786, '{', 786, '}',  786,
    };
    for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
      if (map[i] == lookahead) {
  ...
  case 245: {
    static const uint16_t map[] = {
        '\n', 703, '"', 788, '#', 862, '$', 781, '&', 602, '\'', 491, '(', 654,
        ')',  655, '-', 950, '0', 803, ';', 555, '<', 609, '=',  952, '>', 617,
        '\\', 323, '`', 855, '|', 593, '[', 786, ']', 786, '{',  786, '}', 786,
    };
    for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
      if (map[i] == lookahead) {
        state = map[i + 1];
  ...
  case 248: {
    static const uint16_t map[] = {
        '\n', 706, '"', 788, '#', 862, '$', 781, '&', 602, '\'', 491, '(', 494,
        '-',  950, '0', 804, ';', 554, '<', 610, '>', 617, '\\', 324, '`', 855,
        'e',  866, '|', 593, '[', 786, ']', 786, '{', 786, '}',  786,
    };
    for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
      if (map[i] == lookahead) {
        state = map[i + 1];
  ...
  case 254: {
    static const uint16_t map[] = {
        '\n', 712, '"', 788, '#', 862, '$', 781, '&', 602, '\'', 491, '(',  494,
        ')',  655, '-', 950, '0', 804, ';', 555, '<', 610, '>',  617, '\\', 326,
        '`',  855, '|', 593, '[', 786, ']', 786, '{', 786, '}',  786,
    };
    for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
      if (map[i] == lookahead) {
  ...
  case 257: {
    static const uint16_t map[] = {
        '\n', 715, '"', 788, '#', 862, '$', 781, '&', 602, '\'', 491, '(', 494,
        '-',  950, '0', 803, ';', 554, '<', 609, '>', 617, '\\', 327, '`', 855,
        'e',  956, '|', 593, '[', 786, ']', 786, '{', 786, '}',  786,
    };
    for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
      if (map[i] == lookahead) {
        state = map[i + 1];
  ...
  case 263: {
    static const uint16_t map[] = {
        '\n', 721, '"', 788, '#', 862, '$', 781, '&', 602, '\'', 491, '(', 494,
        '-',  950, '0', 803, ';', 554, '<', 610, '>', 617, '\\', 397, '`', 855,
        'e',  956, '|', 593, '[', 786, ']', 786, '{', 786, '}',  786,
    };
    for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
      if (map[i] == lookahead) {
  ...
  case 264: {
    static const uint16_t map[] = {
        '\n', 722, '!', 669, '"',  788, '#', 816, '$', 780, '&',
        489,  '*', 637, '-', 632,  '0', 945, '<', 612, '>', 618,
        '?',  760, '@', 941, '\\', 106, '_', 948, '|', 593,
    };
    for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
      if (map[i] == lookahead) {
        state = map[i + 1];
  ...
  case 266: {
    static const uint16_t map[] = {
        '\n', 724, '"', 788, '#', 862, '$', 781, '&', 602, '\'', 491, '(',  494,
        ')',  655, '-', 950, '0', 803, ';', 555, '<', 609, '>',  617, '\\', 331,
        '`',  855, '|', 593, '[', 786, ']', 786, '{', 786, '}',  786,
    };
    for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
      if (map[i] == lookahead) {
  ...
  case 267: {
    static const uint16_t map[] = {
        '\n', 725, '!', 669, '"',  788, '#', 816, '$', 780, '&',
        489,  '*', 637, '-', 632,  '0', 945, '<', 613, '>', 618,
        '?',  760, '@', 941, '\\', 193, '_', 948, '|', 593,
    };
    for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
      if (map[i] == lookahead) {
        state = map[i + 1];
  ...
  case 270: {
    static const uint16_t map[] = {
        '\n', 728, '!', 669, '"',  788, '#', 816, '$', 780, '&',
        489,  '*', 637, '-', 632,  '0', 945, '<', 611, '>', 618,
        '?',  760, '@', 941, '\\', 213, '_', 948, '|', 516,
    };
    for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
      if (map[i] == lookahead) {
        state = map[i + 1];
  ...
  case 272: {
    static const uint16_t map[] = {
        '\n', 730, '"', 788, '#', 862, '$', 781, '&', 602, '\'', 491, '(',  494,
        ')',  655, '-', 950, '0', 803, ';', 555, '<', 610, '>',  617, '\\', 399,
        '`',  855, '|', 593, '[', 786, ']', 786, '{', 786, '}',  786,
    };
    for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
      if (map[i] == lookahead) {
  ...
  case 273: {
    static const uint16_t map[] = {
        '\n', 731, '!', 669, '"',  788, '#', 816, '$', 780,
        '&',  599, '*', 637, '-',  632, '0', 945, ';', 555,
        '?',  760, '@', 941, '\\', 128, '_', 948, 'i', 876,
    };
    for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
      if (map[i] == lookahead) {
        state = map[i + 1];
  ...
  case 277: {
    static const uint16_t map[] = {
        '\n', 735, '"', 788, '#', 862, '$', 781, '&', 602, '\'', 491, '(',  654,
        '-',  950, '0', 803, ';', 554, '<', 609, '=', 952, '>',  617, '\\', 335,
        '`',  856, 'e', 956, '|', 593, '[', 786, ']', 786, '{',  786, '}',  786,
    };
    for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
      if (map[i] == lookahead) {
        state = map[i + 1];
  ...
  case 279: {
    static const uint16_t map[] = {
        '\n', 737, '"', 788, '#', 862, '$', 781, '&', 602, '\'', 491, '(',  654,
        '-',  950, '0', 803, ';', 554, '<', 609, '=', 952, '>',  617, '\\', 337,
  ...
  case 281: {
    static const uint16_t map[] = {
        '\n', 739, '"', 788, '#', 862, '$', 781, '&', 602, '\'', 491, '(', 654,
        ')',  655, '-', 950, '0', 803, ';', 555, '<', 609, '=',  952, '>', 617,
        '\\', 339, '`', 856, '|', 593, '[', 786, ']', 786, '{',  786, '}', 786,
    };
    for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
      if (map[i] == lookahead) {
        state = map[i + 1];
  ...
  case 283: {
    static const uint16_t map[] = {
        '\n', 741, '"', 788, '#', 862, '$', 781, '&', 602, '\'', 491, '(', 494,
        '-',  950, '0', 804, ';', 554, '<', 610, '>', 617, '\\', 341, '`', 856,
        'e',  866, '|', 593, '[', 786, ']', 786, '{', 786, '}',  786,
    };
    for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
      if (map[i] == lookahead) {
  ...
  case 285: {
    static const uint16_t map[] = {
        '\n', 743, '"', 788, '#', 862, '$', 781, '&', 602, '\'', 491, '(', 494,
        '-',  950, '0', 803, ';', 554, '<', 609, '>', 617, '\\', 343, '`', 856,
        'e',  956, '|', 593, '[', 786, ']', 786, '{', 786, '}',  786,
    };
    for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
      if (map[i] == lookahead) {
  ...
  case 291: {
    static const uint16_t map[] = {
        '\n', 749, '"', 788, '#', 862, '$', 781, '&', 602, '\'', 491, '(', 494,
        '-',  950, '0', 803, ';', 554, '<', 610, '>', 617, '\\', 347, '`', 856,
        'e',  956, '|', 593, '[', 786, ']', 786, '{', 786, '}',  786,
    };
    for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
      if (map[i] == lookahead) {
  ...
  case 292: {
    static const uint16_t map[] = {
        '\n', 750, '!', 672, '"', 788, '#', 816, '$', 781, '\'', 491, '(', 494,
        '*',  640, '-', 636, '0', 943, '<', 495, '>', 496, '?',  761, '@', 942,
        '\\', 112, '_', 947, '`', 855, '[', 786, ']', 786, '{',  786, '}', 786,
    };
    for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
      if (map[i] == lookahead) {
        state = map[i + 1];
  ...
  case 293: {
    static const uint16_t map[] = {
        '\n', 751, '"', 788, '#', 862, '$', 781, '&', 602, '\'', 491, '(',  494,
        ')',  655, '-', 950, '0', 804, ';', 555, '<', 610, '>',  617, '\\', 349,
        '`',  856, '|', 593, '[', 786, ']', 786, '{', 786, '}',  786,
    };
    for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
      if (map[i] == lookahead) {
  ...
  case 294: {
    static const uint16_t map[] = {
        '\n', 752, '"', 788, '#', 862, '$', 781, '&', 602, '\'', 491, '(',  494,
        ')',  655, '-', 950, '0', 803, ';', 555, '<', 609, '>',  617, '\\', 350,
        '`',  856, '|', 593, '[', 786, ']', 786, '{', 786, '}',  786,
    };
    for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
      if (map[i] == lookahead) {
  ...
  case 296: {
    static const uint16_t map[] = {
        '\n', 754, '"', 788, '#', 862, '$', 781, '&', 602, '\'', 491, '(',  494,
        ')',  655, '-', 950, '0', 803, ';', 555, '<', 610, '>',  617, '\\', 354,
        '`',  856, '|', 593, '[', 786, ']', 786, '{', 786, '}',  786,
    };
    for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
      if (map[i] == lookahead) {
  ...
  case 297: {
    static const uint16_t map[] = {
        ...
        654,  '-', 950, '0', 803, ';', 555, '<', 495, '>', 496,  '\\', 357,
        '`',  855, 'e', 956, '[', 786, ']', 786, '{', 786, '}',  786,
    };
    for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
      if (map[i] == lookahead) {
        state = map[i + 1];
  ...
  case 401: {
    static const uint16_t map[] = {
        '!', 670, '"', 788, '#',  816, '$', 781, '%', 647, '&', 601, '\'', 491,
        '(', 654, ')', 655, '*',  638, '+', 770, ',', 557, '-', 768, '/',  642,
        '0', 944, ':', 765, ';',  554, '<', 607, '=', 563, '>', 616, '?',  761,
        '@', 942, '[', 674, '\\', 301, ']', 675, '^', 595, '_', 946, '`',  856,
        'e', 956, 'i', 955, '{',  666, '|', 592, '}', 818, '~', 772,
    };
    for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
      if (map[i] == lookahead) {
        state = map[i + 1];
  ...
  case 402: {
    static const uint16_t map[] = {
        '!', 670, '"', 788, '#', 816, '$', 781, '%',  649, '&', 601, '\'', 491,
        '(', 654, '*', 638, '+', 630, '-', 633, '/',  644, '0', 943, '<',  607,
        '=', 560, '>', 616, '?', 761, '@', 942, '\\', 19,  ']', 675, '^',  596,
        '_', 947, '`', 855, '|', 592, '[', 786, '{',  786, '}', 786,
    };
    for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
      if (map[i] == lookahead) {
        state = map[i + 1];
  ...
  case 404: {
    static const uint16_t map[] = {
        '!', 670, '"', 788, '#', 862, '$', 781, '%',  649, '&', 600, '\'', 491,
        '(', 654, ')', 655, '*', 638, '+', 771, '-',  769, '/', 644, '0',  803,
        '<', 614, '=', 560, '>', 619, '?', 761, '\\', 311, '^', 596, '`',  856,
        '|', 594, '~', 772, '[', 786, ']', 786, '{',  786, '}', 786,
    };
    for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
      if (map[i] == lookahead) {
        state = map[i + 1];
  ...
  case 405: {
    static const uint16_t map[] = {
        '!', 670, '"', 788, '#', 862, '$', 781, '%',  649, '&', 600, '\'', 491,
        '(', 654, ')', 499, '*', 638, '+', 771, '-',  769, '/', 644, '0',  803,
        '<', 614, '=', 560, '>', 619, '?', 761, '\\', 314, '^', 596, '`',  856,
        '|', 594, '~', 772, '[', 786, ']', 786, '{',  786, '}', 786,
    };
    for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
      if (map[i] == lookahead) {
  ...
  case 406: {
    static const uint16_t map[] = {
        '!', 670, '"', 788, '#', 862, '$', 781, '%',  649, '&', 600, '\'', 491,
        '(', 654, '*', 638, '+', 771, '-', 769, '/',  644, '0', 803, ':',  765,
        '<', 614, '=', 560, '>', 619, '?', 761, '\\', 313, '^', 596, '`',  856,
        '|', 594, '~', 772, '[', 786, ']', 786, '{',  786, '}', 786,
    };
    for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
      if (map[i] == lookahead) {
  ...
  case 409: {
    static const uint16_t map[] = {
        '!',  672, '"', 788, '#', 816, '$', 781, '&', 508, '\'', 491, '(', 494,
        '*',  640, '-', 636, '0', 943, '<', 608, '>', 617, '?',  761, '@', 942,
        '\\', 74,  '_', 947, '`', 855, '[', 786, ']', 786, '{',  786, '}', 786,
    };
    for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
      if (map[i] == lookahead) {
        state = map[i + 1];
  ...
  case 416: {
    static const uint16_t map[] = {
        '!',  672, '"', 788, '#', 816, '$', 781, '\'', 491, '(', 494, ')', 655,
        '*',  640, '-', 636, '0', 943, '<', 495, '>',  496, '?', 761, '@', 942,
        '\\', 110, '_', 947, '`', 855, '[', 786, ']',  786, '{', 786, '}', 786,
    };
    for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
      if (map[i] == lookahead) {
        state = map[i + 1];
  ...
  case 417: {
    static const uint16_t map[] = {
        '!',  672, '"', 788, '#', 862, '$', 781, '&', 508, '\'', 491, '(', 654,
        ')',  655, '-', 950, '0', 803, ';', 490, '<', 608, '>',  617, '[', 674,
        '\\', 304, '`', 855, '{', 666, '|', 590, ']', 786, '}',  786,
    };
    for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
      if (map[i] == lookahead) {
        state = map[i + 1];
  ...
  case 418: {
    static const uint16_t map[] = {
        '!',  672, '"', 788, '#', 862, '$', 781, '&', 508, '\'', 491, '(', 654,
        ')',  499, '+', 771, '-', 769, '0', 803, '<', 608, '>',  617, '[', 674,
        '\\', 305, '`', 855, '{', 666, '|', 591, '~', 772, ']',  786, '}', 786,
    };
    for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
      if (map[i] == lookahead) {
        state = map[i + 1];
  ...
  case 423: {
    static const uint16_t map[] = {
        ...
        499, '+', 771, '-', 769, '0', 803, '<', 495,  '>', 496, '\\', 352,
        '`', 855, '~', 772, '[', 786, ']', 786, '{',  786, '}', 786,
    };
    for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
      if (map[i] == lookahead) {
        state = map[i + 1];
  ...
  case 427: {
    static const uint16_t map[] = {
        '!', 671, '"', 788, '#', 816, '$',  780, '%', 650, '&', 600, ')', 655,
        '*', 639, '+', 631, '-', 634, '/',  645, '0', 945, '<', 615, '=', 562,
        '>', 620, '?', 760, '@', 941, '\\', 67,  '^', 597, '_', 948, '|', 594,
    };
    for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
      if (map[i] == lookahead) {
        state = map[i + 1];
  ...
  case 428: {
    static const uint16_t map[] = {
        '!', 671, '"', 788, '#', 816, '$',  780, '%', 650, '&', 600, ')', 499,
        '*', 639, '+', 631, '-', 634, '/',  645, '0', 945, '<', 615, '=', 562,
        '>', 620, '?', 760, '@', 941, '\\', 181, '^', 597, '_', 948, '|', 594,
    };
    for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
      if (map[i] == lookahead) {
        state = map[i + 1];
  ...
  case 429: {
    static const uint16_t map[] = {
        '!', 671, '"', 788, '#', 816, '$',  780, '%', 650, '&', 600, '*', 639,
        '+', 631, '-', 634, '/', 645, '0',  945, ':', 762, '<', 615, '=', 562,
        '>', 620, '?', 760, '@', 941, '\\', 64,  '^', 597, '_', 948, '|', 594,
    };
    for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
      if (map[i] == lookahead) {
        state = map[i + 1];
  ...
  case 430: {
    static const uint16_t map[] = {
        '!', 671, '"', 788, '#',  816, '$', 780, '%', 650, '&', 600, '*', 639,
        '+', 631, '-', 634, '/',  645, '0', 945, '<', 615, '=', 562, '>', 620,
        '?', 760, '@', 941, '\\', 60,  ']', 675, '^', 597, '_', 948, '|', 594,
    };
    for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
      if (map[i] == lookahead) {
        state = map[i + 1];
  ...
  case 433: {
    static const uint16_t map[] = {
        '!', 506, '"', 788, '#', 862, '$', 785, '%', 650, '&', 600, ')', 499,
        '*', 639, '+', 631, ',', 556, '-', 634, '.', 503, '/', 645, ':', 762,
  ...
  case 437: {
    static const uint16_t map[] = {
        '!', 506, '#', 862, '%', 650, '&', 600, ')', 655, '*', 639, '+', 631,
        '-', 634, '/', 645, '<', 615, '=', 562, '>', 620, '?', 760, '[', 673,
    };
    for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
      if (map[i] == lookahead) {
        state = map[i + 1];
  ...
  case 443: {
    static const uint16_t map[] = {
        '!', 506, '#', 862, '%', 650, '&', 600, ')', 499, '*', 639, '+', 631,
        '-', 634, '/', 645, ':', 762, '<', 615, '=', 562, '>', 620, '?', 760,
    };
    for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
      if (map[i] == lookahead) {
        state = map[i + 1];
  ...
  case 445: {
    static const uint16_t map[] = {
        '!', 669, '"', 788, '#',  816, '$', 780, '&', 489,
        '*', 637, '-', 632, '0',  945, '<', 612, '>', 618,
        '?', 760, '@', 941, '\\', 114, '_', 948, '|', 593,
    };
    for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
      if (map[i] == lookahead) {
        state = map[i + 1];
  ...
  case 447: {
    static const uint16_t map[] = {
        '!', 669, '"', 788, '#',  816, '$', 780, '&', 489,
        '*', 637, '-', 632, '0',  945, '<', 613, '>', 618,
        '?', 760, '@', 941, '\\', 197, '_', 948, '|', 593,
    };
    for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
      if (map[i] == lookahead) {
        state = map[i + 1];
  ...
  case 448: {
    static const uint16_t map[] = {
        ...
        632, '0', 945, '?', 760, '@', 941, '\\', 132, '_', 948, '|', 590,
    };
    for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
      if (map[i] == lookahead) {
        state = map[i + 1];
  ...
  case 475: {
    static const uint16_t map[] = {
        '"', 788, '#', 862, '$',  782, '\'', 491, '(', 653, ')', 655, ';', 553,
        '<', 495, '>', 496, '\\', 389, '`',  855, '{', 666, '|', 590, '}', 818,
    };
    for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
      if (map[i] == lookahead) {
        state = map[i + 1];
  ...
  case 549:
    ...
    if ((!eof &&
         set_contains(sym__comment_word_character_set_1, 12, lookahead))) {
      state = 958;
      goto next_state;
    };
    return result;
  ...
  case 812:
    ...
    if (('0' <= lookahead && lookahead <= '9') ||
        ('@' <= lookahead && lookahead <= 'Z') || lookahead == '_' ||
        ('a' <= lookahead && lookahead <= 'z')) {
      state = 812;
      goto next_state;
    };
  ...
  case 880:
    ...
    ;
    {
      static const uint16_t map[] = {
          '\n', 689,  '!', 670,  '"', 788, '#', 816, '$', 781, '%', 649, '&',
          601,  '\'', 491, '(',  654, ')', 655, '*', 638, '+', 630, '-', 633,
          '/',  644,  '0', 943,  ';', 555, '<', 607, '=', 560, '>', 616, '?',
          761,  '@',  942, '\\', 14,  '^', 596, '_', 947, '`', 855, '|', 592,
      };
      for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
        if (map[i] == lookahead) {
          state = map[i + 1];
  ...
  case 882:
    ...
    ;
    {
      static const uint16_t map[] = {
          '\n', 693,  '!', 672, '"', 788, '#', 816, '$', 781, '&',
          602,  '\'', 491, '(', 654, '*', 640, '-', 636, '0', 943,
          ';',  554,  '<', 609, '=', 952, '>', 617, '?', 761, '@',
          942,  '\\', 27,  '_', 947, '`', 855, 'e', 871, '|', 593,
      };
      for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
        if (map[i] == lookahead) {
          state = map[i + 1];
  ...
  case 886:
    ...
    ;
    {
      static const uint16_t map[] = {
          '\n', 699,  '!', 672, '"', 788, '#', 816, '$', 781, '&',
          602,  '\'', 491, '(', 494, '*', 640, '-', 636, '0', 943,
          ';',  554,  '<', 609, '=', 952, '>', 617, '?', 761, '@',
          942,  '\\', 153, '_', 947, '`', 855, 'e', 871, '|', 593,
      };
      for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
        if (map[i] == lookahead) {
          state = map[i + 1];
  ...
  case 888:
    ...
    ;
    {
      static const uint16_t map[] = {
          '\n', 702,  '!', 672,  '"', 788, '#', 816, '$', 781, '&',
          602,  '\'', 491, '(',  654, ')', 655, '*', 640, '-', 636,
          '0',  943,  ';', 555,  '<', 609, '=', 952, '>', 617, '?',
          761,  '@',  942, '\\', 32,  '_', 947, '`', 855, '|', 593,
      };
      for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
        if (map[i] == lookahead) {
          state = map[i + 1];
  ...
  case 894:
    ...
    ;
    {
      static const uint16_t map[] = {
          '\n', 711,  '!', 672,  '"', 788, '#', 816, '$', 781, '&',
          602,  '\'', 491, '(',  494, ')', 655, '*', 640, '-', 636,
          '0',  943,  ';', 555,  '<', 609, '=', 952, '>', 617, '?',
          761,  '@',  942, '\\', 158, '_', 947, '`', 855, '|', 593,
      };
      for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
        if (map[i] == lookahead) {
          state = map[i + 1];
  ...
  case 902:
    ...
    ;
    {
      static const uint16_t map[] = {
          '\n', 723, '!',  672, '"', 788, '#', 816, '$', 781,
          '&',  602, '\'', 491, '(', 494, '*', 640, '-', 636,
          '0',  943, ';',  554, '<', 609, '>', 617, '?', 761,
          '@',  942, '\\', 43,  '_', 947, '`', 855, '|', 593,
      };
      for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
        if (map[i] == lookahead) {
          state = map[i + 1];
  ...
  case 904:
    ...
    ;
    {
      static const uint16_t map[] = {
          '\n', 726,  '!', 672, '"', 788, '#', 816, '$', 781, '&',
          602,  '\'', 491, '(', 494, ')', 655, '*', 640, '-', 636,
          '0',  943,  ';', 555, '<', 609, '>', 617, '?', 761, '@',
          942,  '\\', 46,  '_', 947, '`', 855, '|', 593,
      };
      for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
        if (map[i] == lookahead) {
          state = map[i + 1];
  ...
  case 906:
    ...
    ;
    {
      static const uint16_t map[] = {
          '\n', 729, '!',  672, '"', 788, '#', 816, '$', 781,
          '&',  602, '\'', 491, '(', 494, '*', 640, '-', 636,
          '0',  943, ';',  554, '<', 610, '>', 617, '?', 761,
          '@',  942, '\\', 226, '_', 947, '`', 855, '|', 593,
      };
      for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
        if (map[i] == lookahead) {
          state = map[i + 1];
  ...
  case 909:
    ...
    ;
    {
      static const uint16_t map[] = {
          '\n', 734, '!',  672, '"', 788, '#', 816, '$', 781,
          '&',  489, '\'', 491, '(', 654, '*', 640, '-', 636,
          '0',  943, '<',  609, '=', 952, '>', 617, '?', 761,
          '@',  942, '\\', 48,  '_', 947, '`', 855, '|', 593,
      };
      for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
        if (map[i] == lookahead) {
          state = map[i + 1];
  ...
  case 910:
    ...
    ;
    {
      static const uint16_t map[] = {
          '\n', 736,  '!', 672, '"', 788, '#', 816, '$', 781, '&',
          602,  '\'', 491, '(', 494, ')', 655, '*', 640, '-', 636,
          '0',  943,  ';', 555, '<', 610, '>', 617, '?', 761, '@',
          942,  '\\', 228, '_', 947, '`', 855, '|', 593,
      };
      for (uint32_t i = 0; i < sizeof(map) / sizeof(map[0]); i += 2) {
        if (map[i] == lookahead) {
          state = map[i + 1];
